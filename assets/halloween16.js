(function () {
    var g, aa = aa || {}, ba = this, k = function (a) {
            return void 0 !== a
        }, ca = function () {
        }, da = function () {
            throw Error("a");
    ...
    var ta = Array.prototype.indexOf ? function (a, b, c) {
        ...
        return e
    }, wa = Array.prototype.reduce ? function (a, b, c, d) {
        d && (b = na(b, d));
        ...
        a:{
            for (var c = a.length, d = ia(a) ? a.split("") : a, e = 0; e < c; e++)if (e in d && b.call(void 0, d[e], e, a)) {
                b = e;
                break a
            }
            b = -1
    ...
    var Ga = "StopIteration" in ba ? ba.StopIteration : {
    ...
    var Na = function (a, b) {
        ...
        if (1 < c) {
            ...
            a instanceof Na ? (c = a.Za(), d = a.Ra()) : (c = Ka(a), d = Ja(a));
    ...
    Na.prototype.set = function (a, b) {
        Pa(this.s, a) || (this.w++, this.o.push(a), this.H++);
        this.s[a] = b
    };
    ...
    Na.prototype.S = function (a) {
        Oa(this);
        var b = 0, c = this.H, d = this, e = new Ha;
        e.next = function () {
    ...
    var Qa = function (a) {
        ...
        if (a.forEach && "function" == typeof a.forEach)a.forEach(b, void 0); else if (ha(a) || ia(a))ua(a, b, void 0); else {
            var c;
            if (a.Za && "function" == typeof a.Za)c = a.Za(); else if (a.Ra && "function" == typeof a.Ra)c = void 0; else if (ha(a) || ia(a)) {
                c = [];
    ...
    var Sa = /^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/, Ta = function (a, b) {
        if (a) {
            a = a.split("&");
    ...
    var Wa = function (a, b, c) {
        ...
        b instanceof Ya ? (a.s = b, fb(a.s, a.o)) : (c || (b = ab(b, gb)), a.s = new Ya(b, 0, a.o))
    }, $a = function (a, b) {
    ...
    }, bb = /[#\/\?@]/g, db = /[\#\?:]/g, cb = /[\#\?]/g, gb = /[\#\?@]/g, eb = /#/g, Ya = function (a, b, c) {
        this.s = this.o = null;
        this.w = a || null;
        this.H = !!c
    }, kb = function (a) {
        a.o || (a.o = new Na, a.s = 0, a.w && Ta(a.w, function (b, c) {
            jb(a, decodeURIComponent(b.replace(/\+/g, " ")), c)
        }))
    }, jb = function (a, b, c) {
        kb(a);
        a.w = null;
    ...
    g.Za = function () {
        kb(this);
        for (var a = this.o.Ra(), b = this.o.Za(), c = [], d = 0; d < b.length; d++)for (var e = a[d], f = 0; f < e.length; f++)c.push(b[d]);
        return c
    };
    g.Ra = function (a) {
        kb(this);
        var b = [];
        if (ia(a))nb(this, a) && (b = za(b, this.o.get(lb(this, a)))); else {
            a = this.o.Ra();
    ...
    g.toString = function () {
        ...
        if (!this.o)return "";
        for (var a = [], b = this.o.Za(), c = 0; c < b.length; c++)for (var d = b[c], e = encodeURIComponent(String(d)), d = this.Ra(d), f = 0; f < d.length; f++) {
            var h = e;
    ...
    var lb = function (a, b) {
        ...
        b && !a.H && (kb(a), a.w = null, a.o.forEach(function (a, b) {
            var c = b.toLowerCase();
            b != c && (mb(this, b), mb(this, c), 0 < a.length && (this.w = null, this.o.set(lb(this, c), Aa(a)), this.s += a.length))
        }, a));
        a.H = b
    };
    var qb = function (a) {
        var b = new Image, c = ob, d = "";
        b.onerror = b.onload = b.onabort = function () {
            delete pb[c]
        };
        pb[c] = b;
        -1 != a.search("&ei=") || (d = "&ei=");
        a = "https://www.google.com/gen_204?atyp=i&ct=doodle&cad=" + a + d + "&zx=" + pa();
        /^http:/i.test(a) && "https:" == window.location.protocol ? delete pb[c] : (b.src = a, ob = c + 1)
    }, pb = [], ob = 0;
    var rb, sb = navigator.userAgent, tb = window.location.href, ub = -1 != sb.indexOf("iPad") || -1 != sb.indexOf("iPhone") || -1 != sb.indexOf("iPod"), vb = -1 != sb.toLowerCase().indexOf("gsa"), wb = ub && vb, xb = vb && !ub, yb = ub || -1 != sb.indexOf("Android") || -1 != sb.indexOf("Mobile") || -1 != sb.indexOf("Silk"), zb = 0 <= sb.indexOf("MSIE"), Ab = -1 != tb.indexOf("/logos/") && -1 != tb.indexOf(".html"), Bb = function () {
        return 0 <= tb.indexOf("fpdoodle=1") && !!document.getElementById("fpdoodle")
    }, Cb = function (a, b) {
        for (var c = 1; c < arguments.length; c += 2) {
            var d =
                arguments[c], e = arguments[c + 1], f = a.style;
    ...
    var r, Sb = {
        ...
        Xa: !1,
        Va: !1
    }, Yb = {name: "fpdoodle", Pa: !0, Qa: !1, Sa: !1, Ta: !0, Ua: !0, Wa: !0, Xa: !1, Va: !1}, Zb =
    {
    ...
    var dc = function () {
        ...
        null == r && (wb ? r = Ub : xb ? r = Vb : -1 != sb.indexOf("Gbot") ? r = Wb : document.getElementById("fkbx") && !yb ? r = Xb : Bb() ? r = Yb : document.querySelector("body.hp") ? r = yb ? Tb : Sb : Ab ? r = yb ? $b : Zb : (window.console && window.console.log("Error: can't determine environment"), r = yb ? ac : bc), window.console && window.console.log("doodle.environment is " + r.name))
    };
    var fc = function () {
        this.V = this.V;
        this.R = this.R
    ...
    fc.prototype.V = !1;
    fc.prototype.dc = function () {
        this.V || (this.V = !0, this.s())
    };
    var gc = function (a, b) {
        a.V ? k(void 0) ? b.call(void 0) : b() : (a.R || (a.R = []), a.R.push(k(void 0) ? na(b, void 0) : b))
    };
    ...
    var pc = oc("Opera"), qc = oc("Trident") || oc("MSIE"), rc = oc("Edge"), sc = oc("Gecko") && !(-1 != lc.toLowerCase().indexOf("webkit") && !oc("Edge")) && !(oc("Trident") || oc("MSIE")) && !oc("Edge"), tc = -1 != lc.toLowerCase().indexOf("webkit") && !oc("Edge"), uc = function () {
        var a = ba.document;
    ...
    var Dc = !qc || 9 <= Number(Bc), Ec = qc && !Ac("9");
    !tc || Ac("528");
    ...
    var Hc = "closure_listenable_" + (1E6 * Math.random() | 0), Ic = function (a) {
        return !(!a || !a[Hc])
    }, Jc = 0;
    ...
    var Mc = function (a) {
        ...
        b || (b = a.o[h] = [], a.s++);
        var l = Nc(b, c, e, f);
        -1 < l ? (a = b[l], d || (a.Hb = !1)) : (a = new Kc(c, a.src, h, !!e, f), a.Hb = d, b.push(a));
        return a
    }, Pc = function (a, b) {
        var c = b.type;
    ...
    var Rc = "closure_lm_" + (1E6 * Math.random() | 0), Sc = {}, Tc = 0, Uc = function (a, b, c, d, e) {
            if (ga(b)) {
            ...
            d.src = a;
            d.listener = c;
            if (a.addEventListener)a.addEventListener(b.toString(), d, h); else if (a.attachEvent)a.attachEvent(Zc(b.toString()), d); else throw Error("g");
            Tc++;
            return c
        },
        Yc = function () {
            var a = $c, b = Dc ? function (c) {
            ...
            if (ga(b))for (var f = 0; f < b.length; f++)ad(a, b[f], c, d, e); else c = Vc(c), Ic(a) ? Oc(a.w, String(b), c, !0, d, e) : Wc(a, b, c, !0, d, e)
        }, bd = function (a, b, c, d, e) {
            if (ga(b))for (var f = 0; f < b.length; f++)bd(a, b[f], c, d, e); else c = Vc(c), Ic(a) ? a.unlisten(b, c, d, e) : a && (a = Xc(a)) && (b = Qc(a, b, c, !!d, e)) && cd(b)
        }, cd = function (a) {
            ...
            var e = !0;
            if (a = Xc(a))if (b = a.o[b.toString()])for (b = b.concat(), a = 0; a < b.length; a++) {
                var f = b[a];
            ...
            if (!Dc) {
                if (!b)a:{
                    b = ["window", "event"];
                    for (var c = ba, d; d = b.shift();)if (null != c[d])c = c[d]; else {
                        b = null;
                        break a
                    }
                    b = c
                ...
                if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                    ...
                    d = [];
                    for (e = b.s; e; e = e.parentNode)d.push(e);
                    a = a.type;
                    for (e = d.length - 1; !b.w && 0 <= e; e--) {
                        b.s = d[e];
                        var f = ed(d[e], a, !0, b), c = c && f
                    }
        ...
        }, fd = "__closure_events_fn_" + (1E9 * Math.random() >>> 0), Vc = function (a) {
    ...
    gd.prototype.unlisten = function (a, b, c, d, e) {
        if (ga(b))for (var f = 0; f < b.length; f++)this.unlisten(a, b[f], c, d, e); else c = c || this.handleEvent, e = e || this.$ || this, c = Vc(c), d = !!d, b = Ic(a) ? Qc(a.w, String(b), c, d, e) : a ? (a = Xc(a)) ? Qc(a, b, c, d, e) : null : null, b && (cd(b), delete this.o[b.hc]);
        return this
    };
    var id = function (a) {
        Ia(a.o, function (a, c) {
            this.o.hasOwnProperty(c) && cd(a)
        }, a);
        a.o = {}
    };
    ...
    var ld = function (a) {
        ...
        b && b.registerPageVisibilityListener ? (google.doodle || (google.doodle = {}), google.doodle.pvc = function () {
            a.o && a.o()
        }, b.registerPageVisibilityListener("google.doodle.pvc();")) : a.$ && document.addEventListener(a.$, a.o, !1)
    }, od = function (a, b) {
    ...
    sd.prototype.handleEvent = function (a) {
        ...
        this.V = c;
        c = a.type;
        this.ra && 0 == c.indexOf("mouse") || (b = {
            touchstart: "mousedown",
            touchend: "mouseup",
            touchmove: "mousemove"
        }, c in b && (this.ra = !0, c = b[c]), "mousedown" == c && (a.preventDefault(), this.ha && this.ha.focus()), wd(this, c, this.R, this.V))
    };
    var wd = function (a, b, c, d) {
        ...
        } else if ("mouseup" == b)a.w ? (a.w.s("mouseup", c, d), a.w = null) : a.s && a.s.s("mouseup", c, d); else if ("mousemove" == b || "areamove" == b) {
            for (var h = null, e = 0; e < a.o.length; e++)if (f = a.o[e], f.o.contains(c, d)) {
                h = f;
                break
            }
            a.s != h && (a.s && a.s.s("mouseout", c, d), h && h.s("mouseover", c, d), a.s = h);
            if ("mousemove" == b)for (a.w &&
    ...
    var Ad = function () {
        this.$ = this.U = this.W = this.o = this.H = null;
        this.ha = !1;
        this.R = null;
        this.V = this.s = !1;
        this.w = !0;
    ...
    cc();
    var Bd = r.Ua, Cd = Hb(document, "fullscreenElement"), Dd = document[Hb(document, "exitFullscreen")], Gd = function (a, b, c, d) {
        var e = Ed;
        e.o = a;
        e.H = b;
        e.W = d;
    ...
    Ad.prototype.update = function () {
        if (this.s || this.V) {
            var a = null != document[Cd], b = window.innerWidth, c = window.innerHeight;
            ...
            if (b != this.U || c != this.$ || a != this.ha || this.w) {
                ...
                for (var d = !1, e = 0; e < this.H.length; ++e) {
                    var f = this.H[e], h = f.width, l = f.height;
                    Bd && 0 == e && (d = h < l != this.S);
                    var t = d ? Math.min(b / l, c / h) : Math.min(b / h, c / l), h = t * h, l = t * l, W, L;
    ...
    Kd.prototype.contains = function (a, b) {
        ...
        for (var d = !1, e = 0, f = c.length - 2; e < c.length; f = e, e += 2) {
            var h = c[e], l = c[e + 1], t = c[f], f = c[f + 1];
    ...
    var Ed = Ad.ka(), Nd = function (a, b, c, d) {
        fc.call(this);
        this.U = b;
        this.va = b.width;
        this.H = new gd(this);
        ...
        Gd(a, k(c) ? [b].concat(c) : [b], this.H, function (a) {
            ud(e.o, a)
        });
    ...
    Nd.prototype.update = function () {
        Ed.update();
        if (null != document[Cd] && this.U.width != this.va) {
            this.va = this.U.width;
            ...
            var a = this.T * this.w[3], b = this.T * this.w[4];
            this.$ = this.U.width - a;
            xd(this.o, this.S);
    ...
    var Od = 1E3 / 60, Rd = function (a) {
        ...
        if (a.W)a.U = !1; else {
            ...
            a.$ && (a.H.sort(function (a, b) {
                return a.o == b.o ? b.s - a.s : a.o - b.o
            }), a.$ = !1);
            for (var b = 0, c = 0, d; d = a.H[c]; c++)if (d.o <= a.w)Sd(d) && Td(a, d), b++; else break;
            a.H.splice(0, b);
            a.w++;
            Nb(function () {
                Wd(a)
    ...
    m(Yd, fc);
    var Qd = 1E3 / 30, Zd = Qd / 400;
    Yd.prototype.s = function () {
        this.reset();
        this.o = null
    };
    Yd.prototype.reset = function () {
        this.w && (Cb(this.o, "width", "", "height", ""), Ob(0), this.o.style.width = "", this.o.style.height = "");
        if (this.H) {
            var a = this.H;
    ...
    var $d = function (a, b) {
        if (a.o && ec() && !a.w) {
            ...
            var d = c.offsetHeight, e = c.offsetWidth, f = Math.min(640, c.parentNode.clientWidth), h = f / (640 / 360), l = 0, t = Pd.ka();
            a.w = !0;
            Ud(t, function () {
                l = Math.min(1, l + Zd);
                var t = 3 * l * l - 2 * l * l * l, L = d + Math.min(1, Math.max(0, t)) * (h - d), ja = Math.max(0, L - 230) + (document.querySelector("div.og-pdp") ? 36 : 12);
    ...
    ae.prototype.update = function () {
        ...
        if (this.s) {
            ...
            this.V = {
                ...
                ld: be(this, 1E3, a),
                kd: be(this, 5E3, a),
                md: {Ec: Math.round(this.S / this.T), Mc: this.H, min: this.w}
            }
        }
        this.s = a;
    ...
    var de = function (a) {
        ...
        var d = [], e = Number.MIN_VALUE, f = Number.MAX_VALUE, h;
    ...
    var ee = function (a, b) {
        ...
        if (google) {
            ...
            e();
            google.doodle && google.doodle.jesr || (qa("google.doodle.jesr", !0), google.raas && google.raas("doodle",
                {
                    init: function () {
                        e();
    ...
    var ie = function (a, b) {
        var c, d = a.wa;
        if (d)for (c = []; d; d = d.wa)c.push(d);
        a = a.Oa;
        d = b.type || b;
        if (ia(b))b = new Fc(b, a); else if (b instanceof Fc)b.H = b.H || a; else {
            var e = b;
            b = new Fc(d, a);
            Ma(b, e)
        }
        var e = !0, f;
        if (c)for (var h = c.length - 1; !b.w && 0 <= h; h--)f = b.s = c[h], e = he(f, d, !0, b) && e;
        b.w || (f = b.s = a, e = he(f, d, !0, b) && e, b.w || (e = he(f, d, !1, b) && e));
        if (c)for (h = 0; !b.w && h < c.length; h++)f = b.s = c[h], e = he(f, d, !1, b) && e;
        return e
    };
    ...
    ge.prototype.unlisten = function (a, b, c, d) {
        ...
        if (a in e.o) {
            var f = e.o[a];
            b = Nc(f, b, c, d);
            -1 < b ? (Lc(f[b]), Array.prototype.splice.call(f, b, 1), 0 == f.length && (delete e.o[a], e.s--), e = !0) : e = !1
        } else e = !1;
        return e
    };
    ...
    var je = function (a, b, c) {
        if ("function" == fa(a))c && (a = na(a, c)); else if (a && "function" == typeof a.handleEvent)a = na(a.handleEvent, a); else throw Error("i");
    ...
    pe.prototype.send = function (a, b, c, d) {
        ...
        try {
            this.ra = !0, this.o.open(b, String(a), !0), this.ra = !1
        } catch (f) {
            se(this);
            return
        }
        ...
        try {
            ue(this), 0 < this.Ea && ((this.Fa = ve(this.o)) ? (this.o.timeout = this.Ea, this.o.ontimeout = na(this.Ma, this)) : this.U = je(this.Ma, this.Ea, this)), this.T = !0, this.o.send(a), this.T = !1
        } catch (f) {
            se(this)
        }
    };
    ...
    pe.prototype.Ma = function () {
        "undefined" != typeof aa && this.o && (ie(this, "timeout"), this.abort(8))
    };
    var se = function (a) {
        a.H = !1;
        ...
        a.ma || (a.ma = !0, ie(a, "complete"), ie(a, "error"))
    };
    pe.prototype.abort = function () {
        this.o && this.H && (this.H = !1, this.S = !0, this.o.abort(), this.S = !1, ie(this, "complete"), ie(this, "abort"), xe(this))
    };
    pe.prototype.s = function () {
        this.o && (this.H && (this.H = !1, this.S = !0, this.o.abort(), this.S = !1), xe(this, !0));
        pe.Da.s.call(this)
    };
    pe.prototype.Ia = function () {
        this.V || (this.ra || this.T || this.S ? ye(this) : this.Ya())
    };
    pe.prototype.Ya = function () {
        ye(this)
    };
    var ye = function (a) {
        if (a.H && "undefined" != typeof aa && (!a.W[1] || 4 != (a.o ? a.o.readyState : 0) || 2 != ze(a)))if (a.T && 4 == (a.o ? a.o.readyState : 0))je(a.Ia, 0, a); else if (ie(a, "readystatechange"), 4 == (a.o ? a.o.readyState : 0)) {
            a.H = !1;
            try {
                var b = ze(a), c;
                a:switch (b) {
                ...
                if (!(d = c)) {
                    ...
                    if (e = 0 === b) {
                        ...
                        if (!f && ba.self && ba.self.location)var h = ba.self.location.protocol, f = h.substr(0, h.length - 1);
                        e = !qe.test(f ?
                            f.toLowerCase() : "")
                    }
                    d = e
    ...
    var Fe = function (a, b) {
        for (var c = 0, d = 0, e; e = a[d]; d++)De(e, function () {
            c++;
            c == a.length && b()
        }), e.s()
    };
    var Ge = function (a, b) {
    ...
    }, He = !(!window.AudioContext && !window.webkitAudioContext) && !!window.GainNode, Le = function (a) {
        var b = Ie;
        if (He && !b.o) {
            b.o = new (window.AudioContext || window.webkitAudioContext);
            b.w = b.o.createGain();
            b.w.connect(b.o.destination);
            for (var c in b.S)b.S[c].S = b.o;
            for (c in b.H)Je(b.H[c], b.o, b.w);
            ub && (Ke(b), ad(a, "touchend", function () {
                Ke(b)
            }))
        }
    }, Me = function (a) {
        ...
        a.o && (null == a.s ? Me(a) : k(a.s.playbackState) ? a.s.playbackState !== a.s.PLAYING_STATE && a.s.playbackState !== a.s.FINISHED_STATE && Me(a) : Me(a))
    };
    ...
    }, Oe = document.createElement("audio"), Pe = "function" == fa(Oe.canPlayType) && "" != Oe.canPlayType("audio/ogg") ? ".ogg" : ".mp3", Qe = function (a) {
        if (a.o) {
            var b = 1E3 * a.o.currentTime, c;
            for (c in a.s) {
                var d = a.s[c];
                !d.Jc && d.Nc + a.S < b && delete a.s[c]
            }
        }
    };
    ...
    v.prototype.stop = function (a) {
        Qe(this);
        if (k(a)) {
            if (this.s[a]) {
                try {
                    this.s[a].node.stop(0)
                } catch (c) {
                }
                delete this.s[a]
            }
        } else for (var b in this.s)this.stop(b)
    };
    var Re = function (a, b) {
        Be.call(this, a + b + Pe);
        this.S = this.R = null;
    ...
    Re.prototype.s = function (a) {
        if ((0 == this.o || a) && this.S) {
            a = new pe;
            a.$ = "arraybuffer";
            var b = this;
            a.listen("complete", function () {
                b.S.decodeAudioData(Ae(this), function (a) {
                    a && (b.R = a, b.o = 3, Ce(b))
                });
                b.o = 2
            });
    ...
    m(Se, Ge);
    var w = {
        Ga: new Re("/halloween16/assets/", "main"),
        Rc: new Re("/halloween16/assets/", "initial"),
        yc: new Re("/halloween16/assets/", "victory"),
        vb: new Re("/halloween16/assets/", "end")
    }, x = {
    ...
    var Xe = function () {
        Te.call(this, "/halloween16/assets/", We)
    };
    m(Xe, Te);
    var We = [{filename: "cta-png-sprite.png", size: [217, 80]}, {
            ...
            filename: "level3-jpg-sprite.png", size: [640,
                360]
            ...
            filename: "end-jpg-sprite.png", size: [640,
                360]
        }, {
            filename: "main-jpg-sprite.jpg",
            size: [1283, 280]
        }], Ye = [1, 1315, 1130, 46, 24], Ze = [1, 421, 1200, 43, 32], $e = [16, 0, 0, 1350, 1069], af = [16, 1353, 0, 1350, 1069], bf = [2, 1894, 0, 189, 124], cf = [20, 0, 0, 640, 280], df = [20, 643, 0, 640, 280], y = [1, 1313, 0, 68, 27], ef = [1, 504, 1302, 69, 68], ff = [1, 381, 1322, 59, 53], gf = [1, 1313, 226, 61, 53], hf = [1, 1313, 170, 61, 53], jf = [1, 1313, 226, 61, 53], kf = [2, 1438, 0, 453, 140], lf = [14, 0, 1089, 159, 41], mf = [5, 74, 0, 71, 71], nf = [5, 0, 0, 71, 71], of = [5, 222, 0, 71, 71], pf = [5, 148, 0, 71, 71], qf = [5, 370, 0, 71, 71], rf = [5, 296, 0, 71, 71], sf = [6,
            241, 0, 236, 105], tf = [6, 0, 0, 238, 101], uf = [2, 2518, 554, 107, 106], vf = [2, 1019, 556, 107, 106], wf = [2, 0, 560, 107, 106], xf = [2, 110, 560, 107, 106], yf = [2, 2959, 0, 160, 106], zf = [2, 3122, 0, 160, 106], Af = [2, 3122, 0, 160, 106], Bf = [2, 3285, 0, 160, 106], Cf = [2, 3285, 0, 160, 106], Df = [2, 3448, 0, 160, 106], Ef = [2, 3448, 0, 160, 106], Ff = [2, 522, 68, 160, 106], Gf = [2, 685, 68, 160, 106], Hf = [2, 848, 68, 160, 106], If = [2, 1011, 68, 160, 106], Jf = [2, 1174, 68, 160, 106], Kf = [2, 2086, 90, 160, 106], Lf = [2, 2959, 109, 160, 106], Mf = [2, 2959, 109, 160, 106], Nf = [2, 2959, 109, 160, 106], Of = [2, 2959, 109,
            160, 106], Pf = [2, 3122, 109, 160, 106], Qf = [2, 3285, 109, 160, 106], Rf = [2, 3448, 109, 160, 106], Sf = [2, 1894, 127, 160, 106], Tf = [2, 1337, 143, 160, 106], Uf = [2, 1337, 143, 160, 106], Vf = [2, 1337, 143, 160, 106], Wf = [2, 1337, 143, 160, 106], Xf = [2, 1337, 143, 160, 106], Yf = [2, 1337, 143, 160, 106], Zf = [2, 1337, 143, 160, 106], $f = [2, 1337, 143, 160, 106], ag = [2, 1337, 143, 160, 106], bg = [2, 1337, 143, 160, 106], cg = [3, 590, 0, 87, 75], dg = [3, 590, 0, 87, 75], eg = [3, 590, 0, 87, 75], fg = [3, 590, 78, 87, 75], gg = [3, 0, 108, 87, 75], hg = [3, 90, 108, 87, 75], ig = [3, 180, 108, 87, 75], jg = [3, 270, 108, 87, 75],
        kg = [3, 270, 108, 87, 75], lg = [3, 270, 108, 87, 75], mg = [3, 180, 108, 87, 75], ng = [3, 90, 108, 87, 75], pg = [3, 0, 108, 87, 75], qg = [3, 590, 78, 87, 75], rg = [3, 590, 0, 87, 75], sg = [3, 590, 0, 87, 75], tg = [3, 360, 108, 87, 75], ug = [3, 450, 108, 87, 75], vg = [3, 540, 156, 87, 75], wg = [3, 630, 156, 87, 75], xg = [3, 0, 186, 87, 75], yg = [3, 0, 186, 87, 75], zg = [3, 0, 186, 87, 75], Ag = [3, 630, 156, 87, 75], Bg = [3, 540, 156, 87, 75], Cg = [3, 450, 108, 87, 75], Dg = [3, 90, 186, 87, 75], Eg = [3, 590, 0, 87, 75], Fg = [3, 590, 0, 87, 75], z = [1, 0, 293, 122, 134], Gg = [1, 1101, 300, 122, 134], Hg = [1, 1226, 300, 122, 134], Ig = [1, 614, 302,
            122, 134], Jg = [1, 739, 322, 122, 134], Kg = [1, 864, 333, 122, 134], Lg = [1, 375, 335, 122, 134], Mg = [1, 0, 430, 122, 134], Ng = [1, 125, 430, 122, 134], Og = [1, 250, 430, 122, 134], Pg = [1, 989, 437, 122, 134], Qg = [1, 1114, 437, 122, 134], Rg = [1, 1239, 437, 122, 134], Sg = [1, 500, 439, 122, 134], Tg = [1, 750, 470, 122, 134], Ug = [1, 125, 567, 122, 134], Vg = [1, 250, 567, 122, 134], Wg = [1, 875, 574, 122, 134], Xg = [1, 1250, 574, 122, 134], Yg = [1, 500, 576, 122, 134], Zg = [1, 625, 596, 122, 134], $g = [1, 750, 607, 122, 134], ah = [1, 875, 711, 122, 134], bh = [1, 500, 713, 122, 134], ch = [1, 625, 733, 122, 134], dh = [1, 375,
            746, 122, 134], eh = [1, 875, 848, 122, 134], fh = [1, 1E3, 848, 122, 134], gh = [1, 375, 883, 122, 134], hh = [1, 1E3, 985, 118, 85], ih = [1, 1121, 985, 118, 85], jh = [1, 1242, 985, 118, 85], kh = [1, 500, 987, 118, 85], lh = [1, 621, 1007, 118, 85], mh = [1, 742, 1018, 118, 85], nh = [3, 0, 0, 115, 105], oh = [3, 118, 0, 115, 105], ph = [3, 236, 0, 115, 105], qh = [3, 354, 0, 115, 105], rh = [3, 472, 0, 115, 105], sh = [2, 0, 0, 519, 283], th = [2, 2864, 161, 56, 45], uh = [0, 166, 54, 26, 26], vh = [1, 85, 1115, 82, 78], wh = [1, 170, 1115, 82, 78], xh = [1, 255, 1115, 82, 78], yh = [1, 795, 1122, 82, 78], zh = [1, 880, 1122, 82, 78], Ah = [0, 166,
            0, 51, 51], Bh = [1, 989, 333, 102, 87], Ch = [1, 500, 335, 102, 87], Dh = [1, 875, 470, 102, 87], Eh = [1, 375, 1020, 102, 87], Fh = [1, 375, 1020, 102, 87], Gh = [4, 0, 0, 640, 360], Hh = [19, 0, 0, 640, 360], Ih = [2, 522, 0, 455, 65], Jh = [2, 980, 0, 455, 65], Kh = [2, 3233, 709, 78, 63], Lh = [2, 2802, 296, 50, 50], Mh = [2, 1286, 177, 42, 31], Nh = [2, 2432, 718, 42, 31], Oh = [8, 2327, 0, 59, 77], Ph = [8, 2148, 564, 154, 205], Qh = [8, 2305, 564, 153, 179], Rh = [2, 2271, 0, 169, 158], Sh = [2, 2086, 0, 182, 87], Th = [2, 1134, 177, 149, 95], Uh = [2, 2206, 199, 20, 40], Vh = [1, 955, 169, 143, 161], Wh = [15, 3834, 230, 52, 61], Xh = [12, 418,
            624, 390, 360], Yh = [12, 811, 624, 390, 360], Zh = [12, 0, 936, 390, 360], $h = [12, 393, 987, 390, 360], A = [1, 653, 0, 179, 158], ai = [17, 360, 943, 108, 72], B = [1, 421, 1242, 80, 77], bi = [1, 900, 1244, 80, 77], ci = [1, 983, 1244, 80, 77], di = [2, 1813, 522, 50, 50], ei = [1, 480, 1165, 81, 74], fi = [1, 564, 1185, 81, 74], gi = [1, 375, 293, 87, 37], hi = [5, 48, 74, 45, 45], ii = [5, 0, 74, 45, 45], ji = [5, 144, 74, 45, 45], ki = [5, 96, 74, 45, 45], li = [5, 240, 74, 45, 45], mi = [5, 192, 74, 45, 45], ni = [5, 288, 74, 45, 45], oi = [5, 384, 74, 45, 45], pi = [5, 336, 74, 45, 45], qi = [1, 1248, 1410, 39, 45], ri = [2, 2518, 431, 127, 120],
        si = [2, 2518, 431, 127, 120], ti = [2, 0, 437, 127, 120], ui = [2, 130, 437, 127, 120], vi = [2, 260, 437, 127, 120], wi = [2, 390, 443, 127, 120], xi = [2, 520, 443, 127, 120], yi = [2, 2894, 504, 113, 79], zi = [2, 3010, 504, 113, 79], Ai = [2, 3126, 504, 113, 79], Bi = [2, 3242, 504, 113, 79], Ci = [2, 3358, 504, 113, 79], Di = [2, 3474, 504, 113, 79], Ei = [2, 447, 312, 144, 128], Fi = [2, 447, 312, 144, 128], Gi = [2, 594, 312, 144, 128], Hi = [2, 741, 312, 144, 128], Ii = [2, 888, 312, 144, 128], Ji = [2, 1957, 350, 144, 128], Ki = [2, 2802, 369, 144, 128], Li = [2, 2711, 161, 150, 132], Mi = [2, 2711, 161, 150, 132], Ni = [2, 522, 177, 150,
            132], Oi = [2, 675, 177, 150, 132], Pi = [2, 828, 177, 150, 132], Qi = [2, 981, 177, 150, 132], Ri = [2, 981, 177, 150, 132], Si = [2, 2949, 369, 139, 132], Ti = [2, 2949, 369, 139, 132], Ui = [2, 3091, 369, 139, 132], Vi = [2, 3233, 369, 139, 132], Wi = [2, 3375, 369, 139, 132], Xi = [2, 1733, 387, 139, 132], Yi = [2, 1283, 403, 139, 132], Zi = [2, 1500, 143, 151, 116], $i = [2, 1500, 143, 151, 116], aj = [2, 1654, 143, 151, 116], bj = [2, 2249, 161, 151, 116], cj = [2, 2403, 161, 151, 116], dj = [2, 2557, 161, 151, 116], ej = [2, 2557, 161, 151, 116], fj = [2, 650, 443, 120, 130], gj = [2, 650, 443, 120, 130], hj = [2, 773, 443, 120, 130],
        ij = [2, 896, 443, 120, 130], jj = [2, 2648, 447, 120, 130], kj = [2, 1875, 481, 120, 130], lj = [2, 2771, 500, 120, 130], mj = [1, 262, 0, 203, 290], nj = [1, 0, 0, 259, 290];
    ea(Xe);
    ...
    var sj = function (a, b, c, d, e, f) {
        if (6 == arguments.length)rj(this, a, b, c, d, e, f); else {
    ...
    sj.prototype.scale = function (a, b) {
        this.w *= a;
        this.R *= a;
        this.S *= b;
        this.H *= b;
    ...
    C.prototype.removeChild = function (a) {
        ...
        -1 != b && (this.$.splice(b, 1), a.V = null);
        yj(a)
    };
    var E = function (a) {
        a.V && a.V.removeChild(a)
    }, zj = function (a) {
    ...
    var F = function (a, b, c) {
        ...
        a.S.w && a.S.scale(1 / a.S.w, 1 / a.S.H);
        a.S.scale(b, b);
        yj(a)
    }, Bj = function (a, b) {
        a.kb += b;
        ...
        var b = a.S, c = -a.kb, c = wj(new sj, c);
        vj(b, c);
        a.kb = 0;
        yj(a)
    }, Ej = function (a) {
        ...
        this.order = this.yb = this.o = 0
    }, Fj = function (a, b) {
        for (a.Ha.o = -1; null != a;) {
            var c = a.$;
            -1 == a.Ha.o && b(a) && (a.Ha.o = c.length);
            a.Ha.o++;
    ...
    var Jj = function (a, b, c, d, e, f, h, l) {
        this.o = a;
        this.T = b;
        this.s = c;
        this.S = d;
        ...
        if (0 == b)return a.o;
        if (1 == b)return a.H;
        var c = n(a.o, a.s, b), d = n(a.s, a.w, b);
        a = n(a.w, a.H, b);
        c = n(c, d, b);
        d = n(d, a, b);
        return n(c, d, b)
        ...
        if (0 == b)return a.T;
        if (1 == b)return a.V;
        var c = n(a.T, a.S, b), d = n(a.S, a.R, b);
        a = n(a.R, a.V, b);
        c = n(c, d, b);
        d = n(d, a, b);
        return n(c, d, b)
        ...
        for (var d = 0, e = 1, f = 0, h = 0; 8 > h; h++) {
            var f =
                Kj(a, c), l = (Kj(a, c + 1E-6) - f) / 1E-6;
            if (1E-6 > Math.abs(f - b))return c;
            if (1E-6 > Math.abs(l))break; else f < b ? d = c : e = c, c -= (f - b) / l
        }
    ...
    var Oj = function (a, b, c, d) {
        ...
        return a
    }, Nj = Pj(.25, .1, .25), Rj = Pj(.4, 0, 1), Sj = Pj(0, 0, .6), Tj = Pj(.6, 0, .4);
    var Uj = function (a, b, c, d, e, f) {
        H.call(this, b, null, e);
        this.Ba = a;
        this.H = c;
        this.T = d;
        this.U = f || Qj
    ...
    Uj.prototype.update = function (a) {
        this.H || (this.H = Aj(this.Ba));
        a = Uj.Da.update.call(this, a);
        var b = Ca(this.w / this.R, 0, 1), c = Oj(b, this.H.x, this.T.x, this.U), b = Oj(b, this.H.y, this.T.y, this.U);
        F(this.Ba, c, b);
        return a
    };
    var I = function () {
    ...
    var J = function (a, b) {
        ...
        a.ha.push(new H(b, null, c))
    }, Wj = function (a, b) {
        K(a, 0, function () {
            M(a, b)
        })
    }, Xj = function (a, b, c, d, e, f) {
        a.ha.push(new Uj(a, b, c, d, e, f))
    }, N = function (a) {
        a.ha = []
    }, M = function (a, b) {
        a.T.push(b)
    ...
    O.prototype.update = function (a) {
        a = O.Da.update.call(this, a);
        var b = Oj(Ca(this.w / this.R, 0, 1), this.H, this.T, Qj);
        this.Ba.Aa = b;
        return a
    };
    var Zj = Xe.ka(), bk = function () {
        C.call(this);
        this.w = [];
    ...
    m(ak, C);
    ak.prototype.update = function (a) {
        this.U += a;
    ...
    ak.prototype.ya = function (a) {
        a.globalAlpha = this.W;
    ...
    var ik = function () {
        ...
        var a = new hk(14, 3E3), c = new hk(14, 3E3), d = new hk(14, 3E3);
        a.s = -1;
        c.s = -1;
        d.s = -1;
        F(c, 0, 113);
    ...
    m(gk, C);
    gk.prototype.update = function (a) {
        this.w += a / this.R;
        var b = this.w % 1;
    ...
    m(hk, C);
    hk.prototype.update = function (a) {
        this.w += a / this.H;
        a = (this.w + .1) % 1;
        var b = (.8 - .2) / 2, b = b + .2 - b * Math.cos(Math.PI * a / .25);
        .25 < a && .75 > a && (b = .8);
        this.Aa = b
    };
    hk.prototype.ya = function (a) {
        var b = this.R * (.7 + .5 * this.Aa), c = a.createRadialGradient(0, 0, 0, 0, 0, b);
    ...
    var nk = function (a, b) {
        var c = lk, d = [];
        Fj(c.o, function (a) {
            if (a.o)d.push(a); else return !0
        });
        for (var e = 0; e < d.length; e++)d[e].update(a);
        var d = [], f = 0;
        Fj(c.o, function (a) {
            if (a.o)d.push(a), a.Ha.order = ++f, a.Ha.yb = a.s + (a.V ? a.V.Ha.yb : 0); else return !0
        });
        d.sort(function (a, b) {
        ...
        a.setTransform(b.w, b.S, b.R, b.H, b.s, b.o)
    };
    var ok = function () {
        this.w = !1
    };
    ...
    var rk = Xe.ka(), P = function (a, b) {
        ...
        ka(a[0]) ? this.R = {
            ...
            z: null,
            children: null
        } : (this.ra = a, this.R = this.ra[this.va]);
        this.Bc = b ? b : ca
    };
    m(P, I);
    var sk = function (a) {
    ...
    P.prototype.ya = function (a) {
        P.Da.ya.call(this, a);
        if (this.R.Ca) {
            var b = this.R.x || 0, c = this.R.y || 0;
            rk.ya(this.R.Ca, a, b, c, 1, !0, this.W);
            if (this.R.children)for (var d = 0, e; e = this.R.children[d]; d++)rk.ya(e.Ca, a, b + (e.x || 0), c + (e.y || 0), 1, !0, this.W)
        }
    };
    var uk = function (a) {
        return a.R.Ca[3]
    ...
    m(wk, H);
    wk.prototype.update = function (a) {
        this.H && this.H.update(a);
        wk.Da.update.call(this, a)
    };
    wk.prototype.ub = function () {
        this.U.qa(this.ha);
        this.T()
    };
    var S = function (a, b) {
    ...
    var xk = function (a, b, c, d, e) {
        a = p([0, a, 1, b, 2, c, 3, d, 4, e]);
        S.call(this, a);
        this.state = 0
    };
    m(xk, S);
    var yk = Q([ei, ei, ei, ei, ei, ei, fi, [1, 85, 1196, 81, 74], [1, 169, 1196, 81, 74], fi, fi], 83, 0, 0), zk = R([[1, 648, 1196, 81, 74], [1, 337, 1200, 81, 74], [1, 732, 1203, 81, 74], [1, 816, 1203, 81, 74]], 83, 0, 0), Ak = R([[17, 2290, 797, 64, 84]], 83, 0, -2), Bk = R([[17, 2290, 884, 64, 84], [17, 387, 1134, 64, 84]], 83, 0, -2), Ck = Q([[17, 1656, 1014, 100, 113], [17, 1759, 1014, 100, 113], [17, 1862, 1014, 100, 113], [17, 1965, 1014, 100, 113], [17, 360, 1018, 100, 113], [17, 0, 1032, 100, 113]], 83, 0, -2), Dk = Q([B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, B, bi, bi, ci, ci, ci, ci, ci, ci, bi, bi], 83, 0, 0),
        Ek = R([[17, 792, 1160, 63, 82]], 83, 0, 0), Fk = R([[17, 858, 1160, 63, 82], [17, 924, 1160, 63, 82]], 83, 0, 0), Gk = Q([[17, 2256, 0, 104, 113], [17, 2256, 116, 104, 113], [17, 2256, 232, 104, 113], [17, 1335, 1014, 104, 113], [17, 1442, 1014, 104, 113], [17, 1549, 1014, 104, 113]], 83, 0, 0), Hk = Q([Bh, Bh, Bh, Bh, Ch, Ch, Dh, Dh, Eh, Eh, Fh, Fh, Fh, Fh, Fh, Fh, Fh, Fh, Fh, Fh, Eh, Eh, Dh, Dh, Ch, Ch, Bh, Bh, Bh, Bh], 83, 0, 0), Ik = R([[1, 1105, 1073, 102, 87], [1, 1210, 1073, 102, 87], [1, 480, 1075, 102, 87], [1, 585, 1095, 102, 87], [1, 690, 1106, 102, 87], [1, 375, 1110, 102, 87]], 83, 0, 0), Jk = R([[17, 990, 1160, 61,
            84]], 83, 0, -6), Kk = R([[17, 1054, 1160, 61, 84], [17, 1118, 1160, 61, 84]], 83, 0, -6), Lk = Q([[17, 2068, 1122, 92, 113], [17, 1335, 1130, 92, 113], [17, 1430, 1130, 92, 113], [17, 1525, 1130, 92, 113], [17, 1620, 1130, 92, 113], [17, 1715, 1130, 92, 113]], 83, 0, -6), Mk = Q([vh, vh, wh, wh, xh, xh, yh, yh, zh, zh], 83, 0, 0), Nk = R([[1, 965, 1163, 82, 78], [1, 1050, 1163, 82, 78], [1, 1135, 1163, 82, 78], [1, 1220, 1163, 82, 78]], 83, 0, 0), Ok = Q([[17, 2278, 975, 76, 75], [17, 1986, 1130, 76, 75], [17, 103, 1140, 76, 75], [17, 182, 1140, 76, 75], [17, 0, 1148, 76, 75]], 83, 0, 1), Pk = R([[17, 1898, 1130, 85, 81], [17,
            299, 1134, 85, 81]], 83, 0, 1), Qk = Q([[17, 2068, 1014, 95, 105], [17, 103, 1032, 95, 105], [17, 201, 1032, 95, 105], [17, 463, 1089, 95, 105], [17, 2166, 1121, 95, 105], [17, 2264, 1121, 95, 105]], 83, 0, 1), Rk = 83 * Pk.length;
    var Sk = function () {
        C.call(this);
    ...
    m(Sk, C);
    var Tk = /#(.)(.)(.)/, Uk = /^#(?:[0-9a-f]{3}){1,2}$/i;
    var Vk = function (a, b, c) {
        b *= c.length;
        for (var d = 0, e = c[0]; 0 <= b && d < c.length;) {
            var e = c[d], f = Math.min(b, 1);
            if (1 > f) {
                var h = e = new Jj(e.o, e.T, e.s, e.S, e.w, e.R, e.H, e.V);
                if (1 != f) {
                    var l = n(h.o, h.s, f), t = n(h.T, h.S, f), W = n(h.s, h.w, f), L = n(h.S, h.R, f), ja = n(h.w, h.H, f), Ua = n(h.R, h.V, f);
                    h.s = l;
                    h.S = t;
                    l = n(l, W, f);
                    t = n(t, L, f);
    ...
    var Xk = function (a, b, c) {
        ...
        a.restore();
        a.restore()
    }, Zk = [new Jj(390.1, 169.5, 406.9, 185.5, 430.7, 194.3, 476, 162.2), new Jj(452.4, 164.3, 455.4, 164.2, 472.5, 162.8, 475.1, 162.6), new Jj(466.6, 183.9, 467.2, 178.4, 472.8, 167.5, 475.7, 162.6)], $k = function (a,
                                                                                                                                                                                                                           b, c, d) {
    ...
    var Qb = Ja({
        ...
        dd: 7,
        hd: 8
    }), al = [[$k(0, -100, 0, 100)], null, [$k(175, 0, -175, 0)], null, null, null, [$k(25, -62.5, -25, 0), $k(-25, 0, 31, -4), $k(31, -4, -19, 58.5)], null, null], bl = [new u(50, 180), null, new u(320, 240), null, null, null, new u(410, 190), null, null], cl = [null, null, null, null, x.wc, null, x.xc, null, null], dl = Rb("#0000ff #22ff43 #ff0000 #ffff00 #ff69b4 #4682b4 #ffd700 #800080 #ff9900".split(" ")), el = function (a) {
    ...
    var hl = Rb([[2, 3611, 0, 6, 20], [2, 2923, 161, 21, 19], [2, 2057, 171, 21, 6], [2, 2057, 149, 22, 19], [2, 2057, 127, 24, 19], null, [2, 2249, 90, 17, 19], null, null]), il = Rb(al), jl = Rb(bl), kl = Rb(cl);
    var ll = function (a, b, c) {
        ...
        return b
    }, ol = {"|": 0, "^": 1, "-": 2, v: 3, z: 6, 3: 4}, ml = function (a, b) {
        a = 2 * a * Math.PI / 360;
    ...
    var rl = pl.ka(), Ml = function () {
        var a = p([0, sl, 1, tl, 2, ul, 3, vl, 4, wl, 5, xl, 6, yl, 7, zl, 8, Al, 9, Bl, 10, Cl, 11, Dl, 12, El, 13, Fl, 14, Gl, 15, Hl, 16, Il, 17, Jl, 18, Kl, 19, Ll]);
        S.call(this, a)
    };
    m(Ml, S);
    var tl = tk([[Vh, 33, 5, [[gi, -2, -27]]]], 83), sl = tk([[[1, 1313, 102, 64, 65], 62, 47], [[1, 0, 1115, 82, 90], 47, 31], [[1, 653, 161, 149, 138], 29, 27], [[1, 999, 0, 159, 166], 28, 0]], 83), ul = tk([[Vh, 33, 3, [[gi, -2, -25]]], [Vh, 33, 1, [[gi, -2, -23]]]], 83), vl = tk([[Vh, 33, 5, [[gi, -3, -23]]], [[1, 835, 0, 161, 162], 27, 4], [[1, 468, 0, 182, 163], 2, 3]], 83), wl = tk([[A, 0, 1], [A, 0, 1], [A, 0, 1]], 83), xl = tk([[A, 0, 1], [A, 0, 1], [A, 0, 1], [A, 0, 1], [A, 0, 3], [A, 0, -1], [A, 0, -3], [A, 0, -1], [A, 0, 1], [A, 0, 3], [A, 0, -1], [A, 0, -3], [A, 0, -1], [A, 0, 1], [A, 0, 3]], 83), yl = tk([[[1, 805, 165, 147, 154],
            36, 0], [[1, 1161, 0, 149, 149], 47, 0], [[1, 1161, 152, 149, 145], 80, 0]], 83), zl = R([[1, 468, 166, 143, 166]], 83, 33, 0), Al = R([Wh, [15, 3889, 230, 52, 61], [15, 3944, 230, 52, 61]], 83, 0, 0), Cl = R([Wh], 83, 0, 0), Dl = R([[14, 2514, 0, 52, 61]], 83, 0, 0), Bl = Q([[14, 2095, 726, 195, 218], [14, 2293, 726, 195, 218], [14, 2095, 947, 195, 218], [14, 2293, 947, 195, 218]], 83, 0, 0), El = R([Xh, Yh, Zh, $h, Xh, Yh, Zh, $h, [12, 786, 987, 390, 360], [12, 0, 1299, 390, 360], [12, 393, 1350, 390, 360], [12, 786, 1350, 390, 360]], 83, 0, 0), Fl = Q([[12, 0, 0, 415, 309], [12, 418, 0, 415, 309], [12, 836, 0, 415, 309], [12,
            0, 312, 415, 309], [12, 418, 312, 415, 309], [12, 836, 312, 415, 309], [12, 0, 624, 415, 309]], 83, 0, 25), Gl = R([[17, 0, 0, 373, 360], [17, 376, 0, 373, 360], [17, 752, 0, 373, 360], [17, 1128, 0, 373, 360]], 83, 0, 0), Hl = Q([[17, 1504, 0, 373, 360], [17, 1880, 0, 373, 360], [17, 0, 363, 373, 360], [17, 376, 363, 373, 360]], 83, 0, 0), Il = R([[17, 620, 726, 59, 67]], 83, 0, 0), Jl = R([[15, 0, 0, 423, 360], [15, 426, 0, 423, 360], [15, 852, 0, 423, 360], [15, 1278, 0, 423, 360], [15, 1704, 0, 423, 360], [15, 2130, 0, 423, 360], [15, 2556, 0, 423, 360], [15, 2982, 0, 423, 360], [15, 3408, 0, 423, 360]], 83, 0, 25), Kl = R([[13,
            0, 0, 416, 360], [13, 419, 0, 416, 360], [13, 838, 0, 416, 360], [13, 1257, 0, 416, 360], [13, 1676, 0, 416, 360], [13, 2095, 0, 416, 360], [13, 2514, 0, 416, 360], [13, 2933, 0, 416, 360], [13, 3352, 0, 416, 360], [13, 3771, 0, 416, 360], [13, 0, 363, 416, 360], [13, 419, 363, 416, 360], [13, 838, 363, 416, 360], [13, 1257, 363, 416, 360], [13, 1676, 363, 416, 360], [13, 2095, 363, 416, 360], [13, 2514, 363, 416, 360], [13, 2933, 363, 416, 360], [13, 3352, 363, 416, 360], [13, 3771, 363, 416, 360], [14, 0, 0, 416, 360]], 83, 0, 25), Ll = R([[14, 419, 0, 416, 360], [14, 838, 0, 416, 360], [14, 1257, 0, 416, 360], [14,
            1676, 0, 416, 360], [14, 2095, 0, 416, 360], [14, 0, 363, 416, 360], [14, 419, 363, 416, 360], [14, 838, 363, 416, 360], [14, 1257, 363, 416, 360], [14, 1676, 363, 416, 360], [14, 2095, 363, 416, 360], [14, 0, 726, 416, 360], [14, 419, 726, 416, 360], [14, 838, 726, 416, 360], [14, 1257, 726, 416, 360], [14, 1676, 726, 416, 360]], 83, 0, 25), Nl = R([[1, 399, 1378, 40, 40], [1, 1205, 1405, 40, 40], [1, 1149, 1409, 40, 40]], 83, 0, 0), Ol = 83 * sl.length, Pl = 83 * vl.length, Ql = 83 * wl.length, Rl = 83 * xl.length, Sl = 83 * El.length, Tl = 83 * Gl.length, Ul = new u(475, 181), Vl = new u(Ul.x - 90, Ul.y), Wl = 83 * Jl.length,
        Xl = 83 * Kl.length, Yl = 83 * Ll.length;
    Ml.prototype.update = function (a) {
        this.w && 5 == this.w.state && (this.w = null, N(this), this.T = [], x.Ub.stop(), this.qa(17), Xj(this, 300, null, Ul), M(this, new wk(this, 13, Wl)));
        Ml.Da.update.call(this, a)
    };
    var Zl = function (a) {
        T(a, 18, 4E3);
        Wj(a, new H(1E3, null, function () {
            x.Ub.play()
        }));
        T(a, 19, Xl, Ul, Vl, function () {
            x.Zb.play();
            V(rl, 6);
            Xj(a, 300, null, Ul);
            Zl(a)
    ...
    var $l = Xe.ka(), am = 206 + Oh[4] / 2, bm = Q([[8, 2389, 0, 53, 74], [8, 2389, 77, 53, 74], [8, 2327, 80, 53, 74], [8, 2383, 154, 53, 74], [8, 2327, 157, 53, 74], [8, 2383, 231, 53, 74], [8, 2327, 234, 53, 74], [8, 2383, 308, 53, 74], [8, 2327, 311, 53, 74], [8, 2383, 385, 53, 74], [8, 2327, 388, 53, 74], [8, 2383, 462, 53, 74], [8, 2327, 465, 53, 74], [8, 0, 705, 53, 74], [8, 56, 705, 53, 74], [8, 112, 705, 53, 74], [8, 168, 705, 53, 74], [8, 224, 705, 53, 74], [8, 280, 705, 53, 74], [8, 336, 705, 53, 74], [8, 392, 705, 53, 74], [8, 448, 705, 53, 74], [8, 504, 705, 53, 74], [8, 560, 705, 53, 74]], 83, 545, 155, am - 1), cm = Q([[6,
        480, 0, 199, 123], [6, 682, 0, 199, 123], [6, 884, 0, 199, 123], [6, 1086, 0, 199, 123], [6, 1288, 0, 199, 123], [6, 1490, 0, 199, 123], [6, 1692, 0, 199, 123], [6, 1894, 0, 199, 123], [6, 2096, 0, 199, 123], [6, 2298, 0, 199, 123], [6, 2500, 0, 199, 123], [6, 2702, 0, 199, 123], [6, 2904, 0, 199, 123], [6, 3106, 0, 199, 123], [6, 3308, 0, 199, 123], [6, 3510, 0, 199, 123], [6, 3712, 0, 199, 123], [6, 3914, 0, 199, 123], [6, 4116, 0, 199, 123], [6, 4318, 0, 199, 123], [6, 4520, 0, 199, 123], [6, 4722, 0, 199, 123], [6, 4924, 0, 199, 123], [6, 4924, 0, 199, 123], [6, 4924, 0, 199, 123], [6, 5126, 0, 199, 123], [6, 5328, 0, 199,
        123], [6, 5530, 0, 199, 123]], 83, 329, 81, 0), dm = Q([Rh, [2, 2443, 0, 169, 158], [2, 2615, 0, 169, 158], [2, 2787, 0, 169, 158]], 83, Rh[3] / 2, 360 - Rh[4] / 2, 273), em = [$l.o[Ue(2)], $l.o[Ue(3)], $l.o[Ue(4)], $l.o[Ue(5)]], mm = [{
        ...
        Fb: function (a) {
            var b = function (a) {
                ...
                U(170, 295, 7, "^|"), U(190, 295, 8, "v^"), U(210, 295, 9, "^v")]), Y(a), c([U(162, 217.5, 3, "|"), U(90, 217.5, 3, "-"), U(18, 217.5, 3, "|"), U(-54, 217.5, 3, "-"), U(-126, 217.5, 3, "|"), U(-162, 217.5, 9, "^-|^"), U(-90, 217.5, 9, "v-|v"), U(-18, 217.5, 9, "^--^"), U(54, 217.5, 9, "v--v"), U(126, 217.5, 9, "^-|^")]), Y(a), b(2), km(a), Y(a), b(1)];
            hm(a, b);
            return b
        },
        state: 16
    ...
    var sm = pl.ka(), Im = function () {
        var a = Q([cg, dg, eg, fg, gg, hg, ig, jg, kg, lg, mg, ng, pg, qg, rg, sg, tg, ug, vg, wg, xg, yg, zg, Ag, Bg, Cg, Dg, Eg, Fg], 83, 0, 0), b = R([uf, vf, wf, xf], 83, 0, -31), c = Q([yi, zi, Ai, Bi, Ci, Di], 83, 10, -3), d = R([ri, si, ti, ui, vi, wi, xi], 83, 12, -21), e = R([Ei, Fi, Gi, Hi, Ii, Ji, Ki], 83, 0, -26.5), f = R([Zi, $i, aj, bj, cj, dj, ej], 83, 0, -19), h = R([fj, gj, hj, ij, jj, kj, lj], 83, 0, -27), l = Q([hh, ih, jh, kh, lh, mh], 83, 0, -5), t = R([nh, oh, ph, qh], 83, 14, -15), W = R([rh, ph, qh], 83, 14, -15), L = R([Li, Mi, Ni, Oi, Pi, Qi, Ri], 83, 6, -22), ja = R([Si, Ti, Ui, Vi, Wi, Xi, Yi], 83,
            0, -28), Ua = R([yf, zf, Af, Bf, Cf, Df, Ef, Ff, Gf, Hf, If, Jf, Kf, Lf, Mf, Nf, Of, Pf, Qf, Rf, Sf, Tf, Uf, Vf, Wf, Xf, Yf, Zf, $f, ag, bg], 83, 0, 0), a = p([10, c, 1, b, 0, a, 14, c, 8, l, 2, d, 3, e, 4, f, 5, h, 6, L, 7, ja, 11, t, 12, W, 13, tm, 9, um, 16, Ua, 17, vm, 18, wm, 19, xm, 20, ym, 21, zm, 22, Am, 23, Bm, 24, Cm, 25, Dm, 26, Em, 27, Fm, 29, Gm, 28, Hm]), b = p([8, x.Kc]);
        S.call(this, a, b);
        F(this, 320, 180);
        this.w = 5;
        this.ta = this.w - 1;
    ...
    m(Im, S);
    var um = R([[2, 2057, 199, 146, 148], [2, 2057, 199, 146, 148], [2, 2864, 218, 146, 148], [2, 3013, 218, 146, 148], [2, 3162, 218, 146, 148], [2, 3311, 218, 146, 148], [2, 3460, 218, 146, 148], [2, 1808, 236, 146, 148], [2, 1286, 252, 146, 148], [2, 1435, 262, 146, 148], [2, 1584, 262, 146, 148], [2, 1134, 275, 146, 148], [2, 2206, 280, 146, 148], [2, 2355, 280, 146, 148], [2, 2504, 280, 146, 148], [2, 0, 286, 146, 148], [2, 149, 286, 146, 148], [2, 298, 286, 146, 148], [2, 2653, 296, 146, 148], [2, 2653, 296, 146, 148], [2, 2653, 296, 146, 148]], 83, 0, -36), tm = R([rh], 83, 14, -15), vm = R([z, z, z, z, z, z, z, z, z,
        z, z, z, z, z, [1, 125, 293, 122, 134], [1, 250, 293, 122, 134], z, z, z, z, z, z, z, Gg, Gg, Hg, Hg, Ig, Ig, Jg, Jg, Kg, Kg, Lg, Lg, Mg, Mg, Ng, Ng, Og, Og, Pg, Pg, Qg, Qg, Rg, Rg, Sg, Sg, Sg, Sg, Sg], 83, 0, -9), wm = R([[1, 625, 459, 122, 134], Tg, Tg, Tg, Tg, Tg, Tg, Tg, Tg, [1, 375, 472, 122, 134], [1, 0, 567, 122, 134], Ug, Ug, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Vg, Wg, Wg, Wg, Wg, Wg, Wg, [1, 1E3, 574, 122, 134], [1, 1125, 574, 122, 134]], 83, 0, -9), xm = R([Xg, Xg, Xg, Xg, Yg, Zg, $g, $g, Yg, Zg, Zg, $g, $g, [1, 125, 704, 122, 134], [1, 250, 704, 122, 134]], 83, 0, -9), ym = R([ah, ah, ah, ah, ah, [1, 1E3, 711, 122,
        134], [1, 1125, 711, 122, 134], [1, 1250, 711, 122, 134], bh, bh, bh, ch, ch, ch, ch, [1, 750, 744, 122, 134], dh, dh, dh, dh, dh, dh, dh, dh, dh, dh, [1, 0, 841, 122, 134], [1, 125, 841, 122, 134], [1, 250, 841, 122, 134], eh, eh, eh, eh, eh, eh, eh, eh, eh, eh, eh, eh, eh, eh, [1, 0, 841, 122, 134], fh, fh, fh, fh, [1, 1125, 848, 122, 134]], 83, 0, -9), zm = R([[1, 1250, 848, 122, 134], [1, 500, 850, 122, 134], [1, 625, 870, 122, 134], [1, 750, 881, 122, 134], gh, gh, gh, gh, gh, gh, gh, gh, gh, [1, 0, 978, 122, 134], [1, 125, 978, 122, 134], [1, 250, 978, 122, 134], [1, 875, 985, 122, 134]], 83, 0, -9), Am = R([[15, 3834, 0, 99,
        112], [15, 3936, 0, 99, 112], [15, 3834, 115, 99, 112], [15, 3936, 115, 99, 112]], 83, -2, 17), Bm = R([[17, 2170, 797, 117, 86]], 83, 20, -2), Cm = R([[17, 120, 943, 117, 86], [17, 240, 943, 117, 86]], 83, 20, -2), Dm = R([[17, 2170, 886, 117, 86], [17, 0, 943, 117, 86]], 83, 20, -2), Em = R([[17, 752, 363, 307, 214], [17, 1062, 363, 307, 214], [17, 1372, 363, 307, 214], [17, 1682, 363, 307, 214], [17, 1992, 363, 307, 214], [17, 752, 580, 307, 214], [17, 1062, 580, 307, 214], [17, 1372, 580, 307, 214], [17, 1682, 580, 307, 214], [17, 1992, 580, 307, 214], [17, 1992, 580, 307, 214], [17, 0, 726, 307, 214], [17, 310,
        726, 307, 214], [17, 620, 797, 307, 214], [17, 930, 797, 307, 214], [17, 1240, 797, 307, 214], [17, 1550, 797, 307, 214], [17, 1860, 797, 307, 214]], 83, 60, -35), Fm = Q([[17, 561, 1160, 74, 81], [17, 561, 1160, 74, 81], [17, 638, 1160, 74, 81], [17, 638, 1160, 74, 81], [17, 715, 1160, 74, 81], [17, 715, 1160, 74, 81]], 83, -14, 0), Hm = R([[18, 0, 0, 184, 183], [18, 187, 0, 184, 183], [18, 374, 0, 184, 183], [18, 561, 0, 184, 183], [18, 561, 0, 184, 183], [18, 561, 0, 184, 183], [18, 748, 0, 184, 183], [18, 935, 0, 184, 183], [18, 1122, 0, 184, 183], [18, 1309, 0, 184, 183], [18, 1496, 0, 184, 183], [18, 1683, 0, 184,
        183], [18, 1870, 0, 184, 183], [18, 2057, 0, 184, 183], [18, 2244, 0, 184, 183]], 83, -62, 38), Gm = Q([[17, 471, 943, 105, 143], [17, 2170, 975, 105, 143], [17, 579, 1014, 105, 143], [17, 687, 1014, 105, 143], [17, 795, 1014, 105, 143], [17, 903, 1014, 105, 143], [17, 1011, 1014, 105, 143], [17, 1119, 1014, 105, 143], [17, 1227, 1014, 105, 143]], 83, -124, 65), Jm = 83 * um.length, Km = 83 * tm.length, Lm = 83 * xm.length, Mm = 83 * ym.length, Nm = 83 * vm.length, Om = 83 * zm.length, Pm = 83 * Em.length, Qm = 83 * Hm.length, Rm = p([0, 2, 1, 3, 2, 4, 3, 5, 4, 6, 5, 0, 6, 7, 7, 0, 8, 0]);
    Im.prototype.Kb = function () {
        0 >= this.wa && 1 != this.state && (this.w = Math.max(0, this.w - 1), T(this, 1, 0), this.$a() ? (V(sm, 0), T(this, 16, 350), T(this, 0, this.Ea), K(this, 0, function () {
            V(sm, 16)
        })) : (this.wa = this.Fa, T(this, 0, 350)));
    ...
    Im.prototype.Na = function (a, b) {
        6 == a ? this.Kb() : 5 == a ? this.H = this.H + b : 7 == a || 9 == a ? Vm(this) : 8 == a ? Wm(this) : 18 == a && (this.w = a = this.w + 1, V(sm, 10, a))
    };
    var Xm = function (a, b, c) {
        ...
        a.U ? E(a.U) : (a.U = new P(R([lf], 0, -12, 37)), M(a.U, new rm(a, .7, 3)));
        a.U.s = -1;
        a.U.W = !1;
        D(a, a.U)
    }, Zm = function (a) {
    ...
    $m.prototype.Tb = function () {
        this.H(n(this.U, this.T, Ca(this.w / this.R, 0, 1)))
    };
    $m.prototype.ub = function () {
        this.H(this.T)
    };
    var an = kk.ka(), bn = function (a) {
        this.w = !1;
        this.H = new I;
        this.s = a;
        this.R = new P($e);
    ...
    bn.prototype.Ja = function () {
        ...
        Wj(this.o, new H(1500, function (b) {
            Bj(a.o, 3.06 / b)
        }));
        ...
        J(this.o, new Uj(this.s, 1E3, null, oj, function () {
            pm().stop();
            x.Ob.play()
        }, Tj));
        ...
        K(this.o, Qm, function () {
            a.s.qa(29)
        });
        Vj(this.o, 1E3);
        J(this.o, new O(this.T, 1700, 0, 1));
        K(this.o, 700, function () {
            a.w = !0
        })
    };
    bn.prototype.Ka = function () {
        N(this.R);
        N(this.s);
        Zm(this.s);
        this.s.W = !1;
    ...
    m(gn, S);
    var cn = tk([[y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [y, 115, 206], [[1, 1300, 1251, 75, 37], 112, 197], [[1, 0, 1208, 81, 43], 112, 191], [[1, 0, 1254, 75, 37], 112, 192], [[1, 1305, 1210, 75, 38], 112, 189], [[1, 1066, 1244, 75, 38], 112, 187], [[1, 1144, 1244, 75, 38], 112, 180], [[1, 1222, 1244, 75, 38], 112, 174], [[1, 504, 1262, 75, 37], 112,
        165], [[1, 1305, 1163, 75, 44], 112, 148], [[1, 232, 1273, 74, 47], 113, 135], [[1, 155, 1273, 74, 59], 114, 116], [[1, 78, 1273, 74, 64], 114, 101], [[1, 658, 1273, 69, 68], 116, 81], [[1, 309, 1277, 69, 68], 116, 69], [[1, 730, 1280, 69, 68], 116, 55], [[1, 802, 1280, 69, 68], 116, 41], [[1, 1066, 1285, 69, 68], 116, 26], [[1, 1138, 1285, 69, 68], 116, 21], [[1, 1210, 1285, 69, 68], 116, 18], [[1, 1313, 30, 67, 69], 118, 15], [[1, 1282, 1291, 69, 68], 116, 16], [[1, 0, 1294, 69, 68], 116, 19], [ef, 116, 20], [ef, 116, 20], [ef, 116, 20], [ef, 116, 20], [ef, 116, 20], [ef, 116, 20]], 83), dn = tk([[[1, 582, 1273, 73,
        64], 112, 21], [[1, 72, 1340, 52, 45], 132, 26], [[1, 232, 1323, 58, 50], 131, 19], [[1, 738, 1351, 51, 47], 133, 17], [[1, 1044, 1356, 51, 46], 133, 18], [[1, 792, 1351, 51, 47], 133, 18], [[1, 1098, 1356, 51, 46], 133, 19], [[1, 1205, 1356, 50, 46], 120, 5], [[1, 1258, 1362, 50, 45], 77, 0], [[1, 788, 1401, 47, 44], 29, 16], [[1, 656, 1404, 46, 42], 19, 22], [[1, 1002, 1405, 46, 42], 19, 20], [[1, 1051, 1405, 46, 42], 19, 17], [[1, 1100, 1405, 46, 42], 19, 19]], 83), en = tk([[ff, 60, 84], [ff, 60, 84], [ff, 60, 84], [ff, 60, 84], [[1, 1315, 1073, 59, 54], 66, 92], [[1, 1313, 170, 61, 53], 67, 96], [gf, 68, 98], [gf, 68,
        98], [[1, 1315, 1073, 59, 54], 66, 92], [hf, 67, 96], [hf, 67, 96], [jf, 68, 98], [jf, 68, 98], [[1, 443, 1322, 54, 50], 53, 82], [[1, 1101, 223, 54, 51], 17, 53], [[1, 576, 1340, 51, 51], 0, 27], [[1, 874, 1324, 54, 50], 3, 26], [[1, 931, 1324, 54, 50], 35, 26], [[1, 988, 1324, 53, 50], 72, 25], [[1, 1101, 169, 55, 51], 137, 21], [[1, 155, 1335, 53, 50], 198, 20], [[1, 630, 1344, 51, 50], 254, 18], [[1, 293, 1348, 51, 50], 329, 18], [[1, 684, 1351, 51, 50], 366, 18], [[1, 1152, 1356, 50, 50], 407, 18], [[1, 614, 166, 11, 29], 446, 23]], 83), fn = R([[1, 0, 1365, 49, 66], [1, 500, 1373, 49, 66], [1, 500, 1373, 49, 66], [1,
        500, 1373, 49, 66], [1, 500, 1373, 49, 66], [1, 500, 1373, 49, 66], [1, 443, 1375, 49, 66], [1, 211, 1376, 49, 66], [1, 846, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 898, 1377, 49, 66], [1, 950, 1377, 49, 66], [1, 347, 1378, 49, 66], [1, 52, 1388, 49, 66], [1, 104, 1388, 49, 66], [1, 156, 1388, 49, 66], [1, 552, 1394, 49, 66], [1, 604, 1397, 49, 66], [1, 604, 1397, 49, 66], [1, 604, 1397, 49, 66], [1, 263, 1401, 49, 66]], 83, 0, 0), hn = 83 * cn.length, jn = 83 * fn.length;
    var kn = kk.ka(), ln = function (a) {
        this.w = !1;
        this.H = new I;
        this.s = a;
        this.T = new P($e);
    ...
    ln.prototype.Ja = function () {
        ...
        K(this.s, 249, function () {
            E(a.V);
            Ym(a.s)
        });
        K(this.s, 300, function () {
            x.Wb.play();
            Xj(a.T, 1700, null, Z.backgroundPosition || oj, null, Tj)
        });
        Xj(this.s, 700, null, new u(520, -this.s.R.Ca[4] / 2), function () {
            G(a.s, nm())
        }, Rj);
        Vj(this.s, 300);
        ...
        K(this.o, 200, function () {
            a.R.o = !0
        });
        T(this.o, 8, 200);
        T(this.o, 11, jn - 200);
        T(this.o, 9, 83, null, null, function () {
            x.Hc.play();
            G(a.o, .27)
        });
        ...
        J(this.o, new $m(1500, .27, 1, function (b) {
            G(a.o, b)
        }));
        K(this.o, 0, function () {
            G(a.o, 1);
        ...
        T(this.o, 13, Sl);
        K(this.o, Sl, function () {
            a.w = !0
        })
    };
    ln.prototype.Ka = function () {
        N(this.T);
        N(this.s);
        Zm(this.s);
        N(this.H);
    ...
    Xe.ka();
    var pn = function (a, b) {
        var c = p([0, [{Ca: Mh, duration: 0}], 1, [{Ca: Mh, duration: 0}], 2, [{
            Ca: Nh,
            duration: 0
        }], 3, R(mn, nn, 0, 0), 4, R(on, nn, -3, 0)]);
        S.call(this, c);
        F(this, a, b)
    };
    m(pn, S);
    var mn = [Mh, [2, 1286, 211, 42, 31], [2, 1621, 543, 42, 31], [2, 1813, 575, 42, 31], [2, 1621, 577, 42, 31], [2, 2828, 633, 42, 31], [2, 2828, 667, 42, 31], [2, 2432, 684, 42, 31], [2, 2677, 703, 42, 31], Nh], on = [[2, 1985, 719, 41, 38], [2, 2029, 719, 41, 38], [2, 1721, 724, 41, 38], [2, 1765, 724, 41, 38], [2, 1809, 729, 41, 38], [2, 1853, 729, 41, 38], [2, 1615, 731, 41, 38], [2, 1659, 731, 41, 38], [2, 2677, 737, 41, 38], [2, 1529, 745, 41, 38], [2, 1116, 747, 41, 38], [2, 1160, 747, 41, 38]], nn = 1E3 / 12, qn = mn.length * nn, rn = on.length * nn, sn = Mh[3];
    pn.prototype.update = function (a) {
        pn.Da.update.call(this, a);
        a = 1;
        1 == this.state && (a += .1 * Math.max(0, Math.sin(this.ma / 100)));
        G(this, a)
    };
    var tn = {2: !0, 3: !0}, un = {0: !0, 1: !0, 4: !0};
    pn.prototype.qa = function (a) {
        this.state == a || 3 == this.state && 2 == a || 4 == this.state && 1 == a || (tn[a] && un[this.state] ? (N(this), T(this, 2, qn), a = 3) : un[a] && tn[this.state] && (N(this), T(this, 0, rn), a = 4), pn.Da.qa.call(this, a))
    };
    var vn = function (a, b, c, d, e, f, h, l) {
        C.call(this);
        this.H = a;
        this.U = e + "px " + d;
    ...
    m(vn, C);
    vn.prototype.ya = function (a) {
        vn.Da.ya.call(this, a);
        a.save();
        a.font = this.U;
    ...
    yn.prototype.Na = function (a, b) {
        if (10 == a && 5 < b)this.H[this.H.length - 1].qa(2); else if (2 == a) {
            N(this);
            var c = this;
            this.w < b ? J(this, new $m(300, this.w, b, function (a) {
                c.w = Math.ceil(a);
                c.R.H = c.w.toString()
            })) : (this.w = b, this.R.H = this.w.toString())
        }
    };
    yn.prototype.update = function (a) {
        yn.Da.update.call(this, a);
        xn(this)
    };
    var xn = function (a) {
    ...
    var zn = function (a) {
        I.call(this);
        var b = a.position, c = new vn("+" + a.ab.toString(), 0, 0, "'Itim', sans-serif", 24, a.color, "center");
        D(this, c);
        F(this, b.x, b.y - 30);
        this.Aa = 0;
        this.s = 470;
        M(this, new Uj(this, 400, null, new u(b.x, b.y - 60), Nj));
        M(this, new O(c, 400, 1, 0, function () {
            E(c)
        }));
        M(this, new rm(this, 1.1 * (320 > b.x ? -1 : 1), 0, 2))
    };
    m(zn, I);
    var An = pl.ka(), Bn = function () {
        I.call(this);
        this.W = this.H = 0;
        this.R = new I;
        D(this, this.R);
    ...
    var In = function (a, b, c, d) {
        ...
        if (c + 1 != d) {
            var e = Math.floor((c + d) / 2), f = b[c], h = b[d];
        ...
        for (var d = 0; d < b.length - 1; d += 1) {
            ...
            a.translate(e.x, e.y);
            a.scale(.2, .2);
            var h = f.x - e.x, e = f.y - e.y, f = Math.sqrt(h *
                h + e * e);
    ...
    var Ln = Xe.ka(), Mn = function (a) {
        C.call(this);
        this.w = a
    };
    m(Mn, C);
    Mn.prototype.ya = function (a) {
        for (var b = this.w.length, c = -5, d = 0; d < b; d++)var e = hl[this.w[d]], c = c + (e[3] + 5);
        c = -c / 2;
        for (d = 0; d < b; d++)e = hl[this.w[d]], Ln.ya(e, a, Math.floor(c), Math.floor(-e[4] / 2)), c += e[3] + 5
    };
    var Nn = pl.ka(), On = function (a, b, c, d, e, f, h) {
        S.call(this, a, h);
        this.ab = b;
        this.Ma = new Hn;
        this.Ma.o = !1;
    ...
    m(On, S);
    var Pn = R([[2, 1957, 236, 83, 105]], 83, 0, 0), Qn = R([[2, 1701, 522, 109, 91], [2, 1173, 538, 109, 91], [2, 1285, 538, 109, 91], [2, 1397, 543, 109, 91], [2, 1509, 543, 109, 91], [2, 1509, 543, 109, 91], [2, 1509, 543, 109, 91], [2, 1509, 543, 109, 91]], 83, 0, 0), Rn = R([[2, 1998, 604, 97, 112], [2, 1813, 614, 97, 112], [2, 1621, 616, 97, 112], [2, 1129, 632, 97, 112], [2, 1229, 632, 97, 112], [2, 2728, 633, 97, 112], [2, 1329, 637, 97, 112], [2, 1429, 637, 97, 112]], 83, 0, 0), Sn = R([[2, 1957, 236, 83, 105], [2, 1035, 312, 83, 105], [2, 1173, 426, 83, 105], [2, 1721, 616, 83, 105], [2, 1529, 637, 83, 105], [2, 196,
        683, 83, 105], [2, 2098, 684, 83, 105], [2, 2184, 684, 83, 105], [2, 2184, 684, 83, 105]], 83, 0, 0);
    On.prototype.La = function (a) {
        if (0 < a) {
            this.H = a;
            var b = Aj(this), c = om(), d = 1 - .2 * nm();
    ...
    g.Bb = function () {
        var a = this;
        T(this, 4, this.wa, null, null, function () {
            a.Aa = .8;
            M(a, new O(a, 500, .8, 0))
        });
        T(a, 6, 500)
    ...
    g.Lb = function () {
        var a = this.w.shift(), a = dl[a];
        if (this.Eb())Un(this, a); else {
            V(Nn, 11, {ab: this.ab, position: Aj(this), color: a});
            this.qa(3);
            var b = this;
            M(this, new H(this.U, null, function () {
                b.mc()
            }));
            this.Mb()
        }
    ...
    var Un = function (a, b) {
        ...
        a.Ma.o = !0;
        M(a, new H(500, null, function () {
            a.Ma.o = !1
        }))
    };
    On.prototype.update = function (a) {
        On.Da.update.call(this, a);
        this.$a() ? E(this) : 1 == this.state && (N(this), this.T = [], this.qa(2), V(Nn, 6), x.Zb.play(), this.Bb())
    };
    On.prototype.Na = function (a) {
        19 == a && this.V && this.o && !this.$a() && (Vn(this), this.Lb())
    };
    ...
    m(Xn, On);
    var Yn = R([[2, 1733, 262, 69, 105], [2, 3314, 709, 69, 105], [2, 3386, 709, 69, 105], [2, 3458, 709, 69, 105], [2, 3530, 709, 69, 105], [2, 849, 711, 69, 105], [2, 921, 711, 69, 105], [2, 1913, 715, 69, 105]], 83, 0, 0), Zn = R([[2, 1425, 413, 135, 127], [2, 1563, 413, 135, 127], [2, 1035, 426, 135, 127], [2, 2104, 431, 135, 127], [2, 2242, 431, 135, 127], [2, 2380, 431, 135, 127], [2, 2380, 431, 135, 127]], 83, 0, 0), $n = R([[2, 3517, 369, 97, 120], [2, 3517, 369, 97, 120], [2, 1998, 481, 97, 120], [2, 220, 560, 97, 120], [2, 2098, 561, 97, 120], [2, 2198, 561, 97, 120], [2, 2298, 561, 97, 120], [2, 2398, 561, 97, 120],
        [2, 320, 566, 97, 120], [2, 420, 566, 97, 120], [2, 520, 566, 97, 120], [2, 620, 576, 97, 120], [2, 620, 576, 97, 120], [2, 620, 576, 97, 120], [2, 620, 576, 97, 120], [2, 620, 576, 97, 120], [2, 620, 576, 97, 120], [2, 620, 576, 97, 120], [2, 620, 576, 97, 120], [2, 720, 576, 97, 120], [2, 820, 576, 97, 120], [2, 2628, 580, 97, 120], [2, 2894, 586, 97, 120], [2, 2994, 586, 97, 120], [2, 3094, 586, 97, 120], [2, 3194, 586, 97, 120], [2, 3294, 586, 97, 120], [2, 3394, 586, 97, 120], [2, 3494, 586, 97, 120]], 83, 0, 0), ao = R([[2, 920, 576, 95, 132], [2, 920, 576, 95, 132], [2, 2498, 663, 95, 132], [2, 1018, 665, 95, 132], [2,
        0, 669, 95, 132], [2, 98, 669, 95, 132], [2, 98, 669, 95, 132]], 83, 0, 0), bo = Q([[3, 180, 186, 67, 109], [3, 250, 186, 67, 109], [3, 320, 186, 67, 109], [3, 390, 186, 67, 109]], 83, 0, 0);
    Xn.prototype.Bb = function () {
        var a = this;
        T(this, 9, this.wa);
        T(this, 0, this.U, Aj(this), new u(this.Ea, this.Fa), function () {
            a.La(a.H)
        })
    };
    ...
    var co = function (a, b, c, d, e, f, h, l) {
        d = p([5, x.sc]);
        ...
        this.Ea = 0;
        this.hb = ["--^--", "||v||", "|-^-|"];
        this.mb = [[U(-30, 295, 8, "---"), U(20, 140, 8, "|||")], [U(-30, 295, 8, "-|-"), U(20, 140, 8, "|-|"), U(30, 295, 9, "^")], [U(-20, 295, 8, "^v"), U(20, 295, 8, "v-"), U(30, 295, 9, "-|")]];
        this.ta = [];
        this.zc = e;
        this.Ac = f;
        this.Ia = l;
    ...
    m(co, On);
    var eo = R([[6, 1600, 253, 197, 124], [6, 1800, 253, 197, 124], [6, 2E3, 253, 197, 124], [6, 2200, 253, 197, 124], [6, 2400, 253, 197, 124], [6, 2600, 253, 197, 124], [6, 2800, 253, 197, 124], [6, 3E3, 253, 197, 124], [6, 3200, 253, 197, 124]], 83, 0, 0), fo = R([[6, 0, 231, 197, 124], [6, 200, 235, 197, 124], [6, 400, 253, 197, 124], [6, 600, 253, 197, 124], [6, 800, 253, 197, 124], [6, 1E3, 253, 197, 124], [6, 1200, 253, 197, 124], [6, 1400, 253, 197, 124], [6, 1400, 253, 197, 124]], 83, 0, 0), go = R([[6, 1400, 126, 197, 124], [6, 1600, 126, 197, 124], [6, 1800, 126, 197, 124], [6, 2E3, 126, 197, 124], [6, 2200, 126,
        197, 124], [6, 2400, 126, 197, 124], [6, 2600, 126, 197, 124], [6, 2800, 126, 197, 124], [6, 3E3, 126, 197, 124], [6, 3200, 126, 197, 124], [6, 3400, 126, 197, 124], [6, 3400, 126, 197, 124], [6, 3400, 126, 197, 124], [6, 3400, 126, 197, 124], [6, 3600, 126, 197, 124], [6, 3800, 126, 197, 124], [6, 4E3, 126, 197, 124], [6, 4200, 126, 197, 124], [6, 4200, 126, 197, 124], [6, 4200, 126, 197, 124], [6, 4200, 126, 197, 124], [6, 4200, 126, 197, 124], [6, 4400, 126, 197, 124], [6, 4600, 126, 197, 124], [6, 4800, 126, 197, 124], [6, 5E3, 126, 197, 124], [6, 5200, 126, 197, 124], [6, 5400, 126, 197, 124], [6, 5600, 127,
        197, 124]], 83, 0, 0), ho = R([[6, 5732, 0, 197, 124], [6, 0, 104, 197, 124], [6, 200, 108, 197, 124], [6, 400, 126, 197, 124], [6, 600, 126, 197, 124], [6, 800, 126, 197, 124], [6, 1E3, 126, 197, 124], [6, 1200, 126, 197, 124], [6, 1200, 126, 197, 124], [6, 1200, 126, 197, 124]], 83, 0, 0), io = R([[6, 3400, 253, 197, 124], [6, 3600, 253, 197, 124], [6, 3800, 253, 197, 124], [6, 4E3, 253, 197, 124], [6, 4200, 253, 197, 124], [6, 4400, 253, 197, 124], [6, 4600, 253, 197, 124], [6, 4800, 253, 197, 124]], 83, 0, 0), jo = Q([[6, 5E3, 253, 197, 124], [6, 5200, 253, 197, 124], [6, 5400, 253, 197, 124], [6, 5600, 254, 197, 124],
        [6, 5600, 254, 197, 124]], 83, 0, 0);
    g = co.prototype;
    g.La = function (a) {
        this.Ia = a;
    ...
    g.Bb = function () {
        var a = this;
        T(this, 9, this.wa);
        T(this, 0, this.U, Aj(this), new u(this.zc, this.Ac), function () {
            a.La(a.H)
        })
    };
    g.update = function (a) {
        co.Da.update.call(this, a);
        for (var b = this.ta.length - 1; 0 <= b; b--)this.ta[b].$a() && this.ta.splice(b, 1);
        0 < this.Fa && (this.Fa -= a);
        0 == this.state && (this.Ia -= a);
        if (8 == this.state && 0 == this.ta.length)this.qa(0), this.Ea = 0, (a = this.hb.shift()) || Un(this, 0), Ba(this.w, nl(a)), this.La(this.Ia); else if (0 == this.state && 0 == this.w.length && 0 >= this.Fa) {
            N(this);
            this.qa(7);
            this.Ea = 7;
            var c = this;
            T(this, 8, this.lb, null, null, function () {
                c.Ea = 8;
                var a = c.mb.shift();
    ...
    var mo = function (a, b, c, d, e, f) {
        ...
        this.Fa = e;
        var h = this;
        T(this, 0, 2E3, null, null, function () {
            lo(h)
        })
    };
    m(mo, On);
    var no = R([[8, 1253, 423, 176, 138], [8, 1432, 423, 176, 138], [8, 1611, 423, 176, 138], [8, 1790, 423, 176, 138], [8, 1969, 423, 176, 138], [8, 2148, 423, 176, 138], [8, 0, 564, 176, 138], [8, 179, 564, 176, 138], [8, 358, 564, 176, 138], [8, 537, 564, 176, 138], [8, 716, 564, 176, 138], [8, 895, 564, 176, 138], [8, 1074, 564, 176, 138], [8, 1253, 564, 176, 138]], 83, 0, 0), oo = R([[8, 0, 423, 176, 138], [8, 179, 423, 176, 138], [8, 358, 423, 176, 138], [8, 537, 423, 176, 138], [8, 716, 423, 176, 138], [8, 895, 423, 176, 138], [8, 1074, 423, 176, 138], [8, 1074, 423, 176, 138]], 83, 0, 0), po = R([[8, 179, 141, 176,
        138], [8, 358, 141, 176, 138], [8, 537, 141, 176, 138], [8, 716, 141, 176, 138], [8, 895, 141, 176, 138], [8, 1074, 141, 176, 138], [8, 1253, 141, 176, 138], [8, 1432, 141, 176, 138], [8, 1611, 141, 176, 138], [8, 1790, 141, 176, 138], [8, 1969, 141, 176, 138], [8, 2148, 141, 176, 138], [8, 0, 282, 176, 138], [8, 179, 282, 176, 138], [8, 358, 282, 176, 138], [8, 358, 282, 176, 138], [8, 358, 282, 176, 138], [8, 358, 282, 176, 138], [8, 358, 282, 176, 138], [8, 358, 282, 176, 138], [8, 358, 282, 176, 138], [8, 537, 282, 176, 138], [8, 716, 282, 176, 138], [8, 895, 282, 176, 138], [8, 1074, 282, 176, 138], [8, 1253, 282,
        176, 138], [8, 1432, 282, 176, 138], [8, 1611, 282, 176, 138], [8, 1790, 282, 176, 138], [8, 1969, 282, 176, 138], [8, 2148, 282, 176, 138]], 83, 0, 0), qo = R([[8, 0, 0, 176, 138], [8, 179, 0, 176, 138], [8, 358, 0, 176, 138], [8, 537, 0, 176, 138], [8, 716, 0, 176, 138], [8, 895, 0, 176, 138], [8, 1074, 0, 176, 138], [8, 1253, 0, 176, 138], [8, 1432, 0, 176, 138], [8, 1611, 0, 176, 138], [8, 1790, 0, 176, 138], [8, 1969, 0, 176, 138], [8, 2148, 0, 176, 138], [8, 0, 141, 176, 138]], 83, 0, 0), ro = Q([[8, 1432, 564, 176, 138], [8, 1611, 564, 176, 138], [8, 1790, 564, 176, 138], [8, 1969, 564, 176, 138]], 83, 0, 0);
    ...
    mo.prototype.Mb = function () {
        if (0 == this.w.length) {
            ...
            var a = this;
            T(this, 0, this.U + 1E3, null, null, function () {
                lo(a)
            })
        }
    };
    ...
    var so = function (a, b, c, d, e, f, h) {
        ...
        this.Nb = a;
        this.hb = [[U(200, 295, 999, "-")], [U(160, 295, 999, "|")], [U(200, 295, 999, "^")], [U(200, 295, 999, "v")], [U(160, 295, 999, "--")], [U(200, 295, 999, "-|")], [U(160, 295, 999, "-v")], [U(200, 295, 999, "-^")], [U(160, 295, 999, "|-")], [U(200, 295, 999, "||")], [U(160, 295, 999, "|v")], [U(200, 295, 999, "|^")], [U(160, 295, 999, "v-")], [U(200, 295, 999, "v|")], [U(160, 295, 999, "^-")], [U(200, 295, 999, "^|")],
            [U(160, 295, 999, "-"), U(200, 295, 999, "-")], [U(160, 295, 999, "-"), U(200, 295, 999, "|")], [U(160, 295, 999, "-"), U(200, 295, 999, "v")], [U(160, 295, 999, "-"), U(200, 295, 999, "^")], [U(160, 295, 999, "|"), U(200, 295, 999, "-")], [U(160, 295, 999, "|"), U(200, 295, 999, "|")], [U(160, 295, 999, "|"), U(200, 295, 999, "v")], [U(160, 295, 999, "|"), U(200, 295, 999, "^")], [U(160, 295, 999, "v"), U(200, 295, 999, "-")], [U(160, 295, 999, "v"), U(200, 295, 999, "|")], [U(160, 295, 999, "^"), U(200, 295, 999, "-")], [U(160, 295, 999, "^"), U(200, 295, 999, "|")]];
        this.Ia = 2500;
        this.ta =
            [];
        this.lb = e;
    ...
    m(so, On);
    var to = R([[10, 2691, 198, 204, 195], [10, 2898, 198, 204, 195], [10, 3105, 198, 204, 195], [10, 3312, 198, 204, 195], [10, 3519, 198, 204, 195], [10, 3726, 198, 204, 195], [10, 3933, 198, 204, 195]], 83, 0, 0), uo = R([[10, 1449, 198, 204, 195], [10, 1656, 198, 204, 195], [10, 1863, 198, 204, 195], [10, 2070, 198, 204, 195], [10, 2277, 198, 204, 195], [10, 2484, 198, 204, 195], [10, 2484, 198, 204, 195]], 83, 0, 0), vo = R([[10, 1242, 0, 204, 195], [10, 1449, 0, 204, 195], [10, 1656, 0, 204, 195], [10, 1449, 0, 204, 195], [10, 1863, 0, 204, 195], [10, 2070, 0, 204, 195], [10, 2277, 0, 204, 195], [10, 2484, 0, 204,
        195], [10, 2691, 0, 204, 195], [10, 2484, 0, 204, 195], [10, 2898, 0, 204, 195], [10, 3105, 0, 204, 195], [10, 3312, 0, 204, 195], [10, 3519, 0, 204, 195], [10, 3726, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 3933, 0, 204, 195], [10, 4140, 0, 204, 195], [10, 4347, 0, 204, 195], [10, 4554, 0, 204, 195], [10, 4554, 0, 204, 195], [10, 4554, 0, 204, 195], [10, 4554, 0, 204, 195], [10, 4554, 0, 204, 195], [10, 4554, 0, 204, 195], [10, 4554, 0, 204, 195], [10, 4554, 0, 204, 195],
        [10, 4554, 0, 204, 195], [10, 4761, 0, 204, 195], [10, 4968, 0, 204, 195], [10, 5175, 0, 204, 195], [10, 5382, 0, 204, 195], [10, 0, 198, 204, 195], [10, 207, 198, 204, 195], [10, 207, 198, 204, 195], [10, 207, 198, 204, 195], [10, 207, 198, 204, 195], [10, 207, 198, 204, 195], [10, 207, 198, 204, 195], [10, 207, 198, 204, 195], [10, 207, 198, 204, 195], [10, 414, 198, 204, 195], [10, 621, 198, 204, 195], [10, 828, 198, 204, 195], [10, 1035, 198, 204, 195], [10, 1242, 198, 204, 195]], 83, 0, 0), wo = R([[10, 0, 0, 204, 195], [10, 207, 0, 204, 195], [10, 414, 0, 204, 195], [10, 621, 0, 204, 195], [10, 828, 0, 204, 195],
        [10, 1035, 0, 204, 195], [10, 1035, 0, 204, 195]], 83, 0, 0), xo = Q([[10, 4140, 198, 204, 195], [10, 4347, 198, 204, 195], [10, 4554, 198, 204, 195], [10, 4761, 198, 204, 195], [10, 4968, 198, 204, 195], [10, 5175, 198, 204, 195], [10, 5175, 198, 204, 195], [10, 5175, 198, 204, 195], [10, 5175, 198, 204, 195]], 83, 0, 0), yo = 83 * xo.length;
    so.prototype.Bb = function () {
        var a = this;
        T(this, 9, this.wa);
        T(this, 0, yo, Aj(this), new u(this.lb, this.mb), function () {
            a.La(a.H)
        })
    };
    so.prototype.update = function (a) {
        so.Da.update.call(this, a);
        for (var b = this.ta.length - 1; 0 <= b; b--)this.ta[b].$a() && this.ta.splice(b, 1);
        if (0 == this.state && 0 == this.ta.length)if (0 < this.Ea)this.Ea -= a; else {
            a = this.hb[Math.floor(Math.random() * this.hb.length)];
    ...
    so.prototype.Mb = function () {
        if (0 == this.w.length) {
            ...
            a || Un(this, 0);
            var b = this;
            T(this, 0, this.U, Aj(this), new u(this.lb, this.mb), function () {
                Ba(b.w, nl(a));
                b.Ia *= .8;
                b.La(b.H)
            })
    ...
    var zo = pl.ka(), Co = function (a, b) {
        var c = p([0, Ao, 2, Ao, 3, Ao, 5, Bo, 6, [Bo[Bo.length - 1]]]);
        On.call(this, c, 20, [4], a, b, -35)
    };
    m(Co, On);
    var Ao = Q([[2, 2990, 709, 78, 63], [2, 3071, 709, 78, 63], [2, 3152, 709, 78, 63], Kh, Kh, Kh, Kh, Kh], 83, 0, 0), Bo = R([[2, 1337, 68, 78, 63], [2, 1808, 143, 78, 63], [2, 2104, 350, 78, 63], [2, 1875, 387, 78, 63], [2, 687, 699, 78, 63], [2, 768, 699, 78, 63], [2, 2596, 703, 78, 63], [2, 2828, 709, 78, 63], [2, 2909, 709, 78, 63], [2, 2909, 709, 78, 63], [2, 2909, 709, 78, 63], [2, 2909, 709, 78, 63]], 83, 0, 0);
    Co.prototype.Lb = function () {
        V(zo, 18);
        return Co.Da.Lb.call(this)
    };
    var Do = pl.ka(), Eo = function (a, b) {
        C.call(this);
        this.w = a;
        this.H = null;
        this.T = b;
    ...
    var X = function (a) {
        ...
        return new Hj(function () {
            var c;
            c = b.o.x;
            var d = b.o.y, e = b.s, f = p([0, eo, 8, eo, 7, io, 2, ho, 9, jo, 3, fo, 5, go, 6, [go[go.length - 1]]]);
        ...
        return new Hj(function () {
            var c;
            c = b.o.x;
            var d = b.o.y, e = p([0, no, 2, qo, 9, ro, 3, oo, 5, po, 6, [po[po.length - 1]]]);
        ...
        return new Hj(function () {
            var c;
            c = b.o.x;
            var d = b.o.y, e = p([0, to, 2, wo, 9, xo, 3, uo, 5, vo, 6, [vo[vo.length - 1]]]);
    ...
    Eo.prototype.Na = function (a) {
        20 != a || this.R && !this.R.$a() || (a = ml(190, 295), a = new Co(a.x, a.y), Tn(a), G(a, nm()), D(this.w, a), this.R = a)
    };
    var Fo = pl.ka(), Go = kk.ka(), Ho = function (a, b) {
        this.o = a;
        this.T = b;
        this.S = new C;
    ...
    Lo.prototype.ya = function (a) {
        a.beginPath();
        a.arc(this.o, this.s, this.w, 0, 2 * Math.PI, !0);
        a.fill();
        a.stroke()
    };
    var No = function (a, b, c, d, e, f, h, l, t) {
        e = p([0, R([e], 0, 0, 0), 1, R([f || e], 0, 0, 0)]);
        S.call(this, e);
        this.wa = h;
    ...
    var Po = function (a, b, c, d, e, f) {
        var h = Oo;
        f = f || 0;
        var h = xa(h, function (a) {
                a:if (a = a.Ca, ha(a) && ha(b) && a.length == b.length) {
                    for (var c = a.length, d = 0; d < c; d++)if (a[d] !== b[d]) {
                        a = !1;
                        break a
                    }
                    a = !0
    ...
    var Uo = function (a, b, c, d, e, f, h) {
        ...
        for (b = 0; b < t.length; b++)for (; a.measureText(t[b]).width > f && d > e;)a.font = So("", --d, c);
        a.font = l;
    ...
    var Vo = function (a, b, c, d, e, f, h, l, t, W, L, ja) {
        ...
        if (ja) {
            ...
            a.ya = function (a) {
                ...
                var e = c + 40, d = Ua.w.tb.length * l + 20, b = -d / 2, c = -e / 2, e = e / 2, d = d / 2;
                a.beginPath();
                a.moveTo(c + 20, b);
                a.lineTo(e - 20, b);
    ...
    m(Vo, vn);
    Vo.prototype.ya = function (a) {
        a.fillStyle = this.fillStyle;
        a.textAlign = this.R;
        var b = this.w, c = this.w.fontSize / 4 - (this.w.tb.length - 1) / 2 * this.w.fontSize, d = this.w.fontSize, e = a.font;
        a.font = So(b.fontStyle, b.fontSize, b.fontFamily);
    ...
    ap.prototype.S = function () {
        bp() && !oc("Trident") && !oc("MSIE") && window.gapi && window.gapi.load ? (window.gapi.load("share", na(this.T, this)), Pb("gplus,li")) : (window.open("https://plus.google.com/share?url=" + this.U), Pb("gplus,lo"))
    };
    var bp = function () {
    ...
    ap.prototype.T = function () {
        if (window.gapi && window.gapi.share) {
            ...
            }, b = window.location.toString().match(/[?&]authuser=(\d+)/), b = b && b[1], c = bp() || !!window.google.doodle.sf;
            window.gapi.share.lightbox(a, {
                isLoggedInForGooglePlus: c, onLoginPopupBlocked: function () {
                    Pb("gplus,popupblocked")
                }, onLoginStateChanged: na(function () {
                    qa("google.doodle.sf", !0);
                    this.T()
                }, this), editorText: this.ha,
    ...
    var ep = function () {
        ...
        var a = ep(), a = cp(a), b = new Va("http://www.facebook.com/sharer.php"), c = new Ya;
        jb(c, "u", a);
        Za(b, c);
        window.open(b.toString());
        dp(2)
    };
    var Oo = [{Ca: mf, x: 350, y: 141}, {Ca: nf, x: 350, y: 141}, {Ca: of, x: 431, y: 141}, {
        Ca: pf,
        x: 431,
        y: 141
    }, {Ca: qf, x: 511, y: 141}, {Ca: rf, x: 511, y: 141}, {Ca: Hh, x: 0, y: 0}, {
        Ca: hi,
        x: 528,
        y: 231
    }, {Ca: ii, x: 528, y: 231}, {Ca: ji, x: 474, y: 231}, {Ca: ki, x: 474, y: 231}, {
        Ca: li,
        x: 366,
        y: 231
    }, {Ca: mi, x: 366, y: 231}, {Ca: ni, x: 445, y: 231}, {Ca: oi, x: 420, y: 231}, {
        Ca: pi,
        x: 420,
        y: 231
    }];
    var ip = pl.ka(), jp = function (a, b, c) {
        this.va = b;
        this.ma = c;
        this.V = this.T = !1;
        this.H = 0;
        var d = this;
        c = b ? -40 : 0;
        this.ta = Po(a, mf, nf, function () {
            d.T = !0
        }, q("End Screen - Replay"));
        this.wa = Po(a, of, pf, function () {
            d.V = !0
        }, q("End Screen - New Game"), c);
        this.Ea = Po(a, qf, rf, Ib, q("Search - Icon"), c);
        this.ha = Po(a, li, mi, function () {
            var a = ep(), b = gp(d.H), a = cp(a);
            (new ap(a, window.google.doodle.alt || "", b, "https://www.google.com/logos/2016/halloween16/share.png")).S()
        }, q("Share - G+"));
        ...
        this.U = Po(a, hi, ii, function () {
            var a = d.H;
            dp(5);
            var b = window.location, c = ep(), a = gp(a), c = cp(c), a = {
                subject: Kb,
                body: a + "\n" + c
            }, c = new Ya, l;
    ...
    jp.prototype.Na = function (a, b) {
        2 == a && (this.H = b, this.$.H = "" + this.H)
    };
    var kp = Xe.ka(), mp = function () {
        this.H = 0;
        lp(this, 0, 0)
    }, lp = function (a, b, c) {
        a.w = b;
    ...
    var np = pl.ka(), qp = function (a) {
        ...
        this.hb = a;
        this.wa = [];
        if (pp)for (a = 0; 100 > a; a++)this.wa.push(new mp);
        this.Ia = !1;
        this.R = this.H = this.Ea = this.ta = this.Oa = this.ra = 0
    };
    m(qp, C);
    var Ko = function (a) {
        a.Ia || (Md(a.hb, td, function (b, c, d) {
            a.handleEvent(b, c, d)
        }), a.Ia = !0)
    }, Io = function (a) {
        a.Ia && (xd(a.hb.o, td), a.Ia = !1, a.ha = !1, op(a))
    }, op = function (a) {
        a.w = [];
        a.Ya = [];
        a.Ma = 0;
        ...
        var e = Fn(b), f = a.U.y, h = a.T.y, d = a.Fa, c = a.W, l = b.y / 3, t = Ca(e / 320, 0, 1), W = 10 < a.Ma / ((b.x / 2 + b.y / 2) / 2);
        if (3 < b.x / b.y)return [2, t];
        if (3 > a.Oa &&
            (3 < b.y / b.x && 2 > a.ra || 5 < b.y / b.x && 4 > a.ra))return [0, t];
        var L = [[0], [0, 0], [0, 0, 0]];
        if (0 < b.y)for (var ja = 0, Ua = a.w.length; ja < Ua - 1; ja++)for (var Xp = a.Ya[ja], Cj = (a.w[ja][1] - f) / b.y, hb = 0; hb < L.length; hb++)L[hb][Math.floor(Ca(Cj * (hb + 1), 0, hb))] += Xp;
    ...
    qp.prototype.ya = function (a) {
        a.save();
        var b = pa() - this.lb, c = !this.ha && 500 > b;
        if (this.ha || c)if (c && (a.globalAlpha = 1 - b / 500), this.Fa && this.w.length) {
            ...
            a.stroke();
            b = this.w.length;
            if (0 < b && (a.beginPath(), a.arc(this.w[b - 1][0], this.w[b - 1][1], 10, 0, 2 * Math.PI), a.fillStyle = "white", a.fill(), pp))for (a.globalCompositeOperation = "lighter", c = b - 1, b = this.W.x - (0 < c ? this.w[c - 1][0] : 0), c = this.W.y - (0 < c ? this.w[c - 1][1] : 0), b = Math.sqrt(b * b + c * c), b = Math.min(b, 1.5), c = 0; c < this.wa.length; c++)this.ha && this.wa[c].ya(a), this.wa[c].update(b, this.W.x, this.W.y)
        }
        a.restore()
    };
    var pp = !yb, sp = function (a, b, c) {
        a.ha && (a.ha = !1, a.W = new u(b, c), a.lb = pa(), b = rp(a), ga(b) && 0 < b.length ? (a.mb = b[0], V(np, 4, a.mb)) : V(np, 8))
    };
    qp.prototype.handleEvent = function (a, b, c) {
        switch (a) {
            case "mousemove":
                if (8 > b || 8 > c || 632 < b || 352 < c)sp(this, b, c); else if (this.ha) {
                    this.w.push([b, c]);
    ...
    up.prototype.update = function (a) {
        this.R += a;
        if (this.R >= vp[this.T]) {
            this.R = 0;
    ...
    var xp = Xe.ka(), yp = kk.ka(), zp = function (a, b) {
        this.w = !1;
        this.s = new I;
        this.S = a;
        this.ra = new P(cf);
        ...
        D(this.s, this.wa);
        var e = this;
        this.T = new No(600, 337, 20, b, qi, null, function () {
            e.w = !0
        }, "", function (a) {
            this.Aa = a ? 1 : .8
        });
    ...
    zp.prototype.Ja = function () {
        ...
        var a = this;
        T(this.S, 18, Nm, null, null, function () {
            T(a.ha, 1, 0);
            T(a.W, 1, 83);
            T(a.U, 1, 166)
        });
        K(this.s, 4731, function () {
            F(a.o, 300, 125);
            a.o.o = !0
        });
        T(this.o, 1, Ol);
        ...
        T(this.o, 4, Pl, null, null, function () {
            D(a.o, a.va)
        });
        T(this.o, 5, Ql, null, null, function () {
            a.o.removeChild(a.va)
        });
        T(this.o, 7, Rl);
        K(this.o, 240, function () {
            Bp(a)
        });
        Fe(em, ca)
    };
    var Bp = function (a) {
        ...
        T(a.S, 20, Lm);
        T(a.S, 21, Mm);
        T(a.S, 8, Om, null, null, function () {
            Xj(a.wa, 1E3, null, new u(0, 0));
            a.T.o = !1;
            a.V.o = !1
        });
    ...
    var Cp = pl.ka(), Dp = kk.ka(), Ep = function (a) {
        this.w = !1;
        this.S = new I;
        this.o = a;
        this.s = new P(sh);
    ...
    Ep.prototype.Na = function (a, b) {
        12 == a && (this.R = b)
    };
    var Gp = pl.ka(), Hp = kk.ka(), Ip = function (a, b) {
        this.w = !1;
        this.s = a;
        this.H = b;
    ...
    m(Qp, ok);
    var Op = p([0, "white", 1, "black"]), Pp = p([0, [0, 83, 0, 80, 80], 1, [0, 0, 0, 80, 80]]);
    ...
    Tp.prototype.Ja = function () {
        ...
        Vj(this.o, 200);
        Xm(this.o, a, function () {
            b.w = !0
        })
    };
    Tp.prototype.Ka = function () {
        N(this.o);
        N(this.s);
        E(this.H)
    };
    var Up = kk.ka(), Vp = function (a) {
        this.w = !1;
        this.s = new C;
        this.o = a
    };
    ...
    Vp.prototype.Ja = function () {
        ...
        F(this.o, a);
        G(this.o, nm());
        Xm(this.o, new u(640 + uk(this.o) / 2, a.y), function () {
            b.w = !0
        })
    };
    ...
    Wp.prototype.Na = function (a, b) {
        2 == a ? this.H = b : 3 == a ? this.s = b : 12 == a ? this.o = b : 15 == a && this.reset()
    };
    Wp.prototype.log = function (a, b) {
        if (!Yp[a]) {
            var c = pa(), d = this.w ? c - this.w : 0;
            this.w = c;
            c = window.document;
    ...
    var Zp = Wp.ka(), aq = function (a) {
        this.H = a;
        $p(this);
        this.H[this.w].Ja()
    }, $p = function (a) {
        k(a.w) && a.H[a.w] && a.H[a.w].Ka();
        a.R = 0;
    ...
    aq.prototype.update = function (a) {
        if (a = this.H[this.w].update(a)) {
            if (1 == a && this.R < bq.length - 1)a = bq[++this.R]; else {
                var b = bq.indexOf(a);
                -1 != b && (this.R = b)
            }
            this.H[this.w].Ka();
    ...
    m(cq, C);
    cq.prototype.update = function (a) {
        this.w += a
    };
    ...
    var eq = pl.ka(), fq = kk.ka(), gq = function (a, b, c, d, e) {
        this.w = !1;
        this.$ = d;
        this.o = e;
        this.Ba = new I;
    ...
    g.Na = function (a, b) {
        switch (a) {
            ...
            case 5:
                var c = this;
                J(this.Ba, new H(500, null, function () {
                    c.qa(5)
                }));
                break;
            case 8:
    ...
    var hq = function (a) {
        ...
        T(a.o, 13, 1E3);
        T(a.o, 0, Km);
        Xj(a.T, 2E3, null, new u(490, 180), function () {
            a.qa(2)
        })
    }, iq = function (a) {
        Sm(a.o);
        a.H.o = !0;
        a.S && (a.S.o = !0);
        J(a.Ba, new H(2E3, null, function () {
            a.qa(3)
        }))
    };
    var jq = kk.ka(), kq = function () {
        this.w = !1;
        this.o = new jk("#000", 640, 360);
        this.o.s = 461
    };
    m(kq, ok);
    kq.prototype.Ja = function () {
        D(jq.o, this.o);
        F(this.o, 640, 0);
        J(this.o, new Uj(this.o, 1E3, new u(640, 0), new u(0, 0)));
        var a = this;
        J(this.o, new H(1E3, null, function () {
            a.w = !0
        }))
    };
    ...
    var Ie = Se.ka(), lq = Xe.ka(), ce = ae.ka(), lk = kk.ka(), mq = function (a, b) {
        Nd.call(this, a, b)
    };
    m(mq, Nd);
    ...
    var pq = function (a, b) {
        ...
        this.U = pa();
        this.H = null;
        ec() && (this.H = new Yd(a, 0, c), gc(this, oa(hc, this.H)), dc() || ($d(this.H, function () {
            Pd.ka().stop()
        }), Pd.ka().start()));
        var c = new Im, d = new qp(this.o);
        d.s = 461;
        D(lk.o, d);
        var e = new Ho(c, d), c = p([2, new qk(this.o, this.H), 6, e, 3, new zp(c, this.o), 5, new up(c, this.w), 7, new jp(this.o, !1, this.w), 8, new jp(this.o, !0, this.w), 4, new gq(this.w,
        ...
        this.W = new aq(c);
        b.listen(a, "contextmenu", function (a) {
            a.preventDefault()
        }, !1)
    };
    m(pq, fc);
    ...
    pq.prototype.start = function () {
        !this.o.W.H || xb ? (this.S = !0, this.$()) : nq()
    };
    pq.prototype.$ = function () {
        if (this.T) {
            Nb(this.$, 17, this);
            var a = pa(), b = Math.min(a - this.U, 50);
            this.U = a;
            this.W.update(b);
            nk(b, this.w);
            this.o.update();
            a = this.o;
            null != document[Cd] && a.ta.ya(a.w, this.w, a.$, 0, a.T)
        } else this.S = !1
    };
    var oq = null, qq = function () {
        var a = document.getElementById("hplogo"), b = a ? a.querySelector("canvas") : null;
        lq.s(0, function () {
            oq = new pq(a, b);
            oq.start()
        });
    ...
    (function (a, b, c) {
        ...
        if (b) {
            ...
            dc() ? qq() : Uc(b, "click", function () {
                qq();
                if (b)if (Ic(b))b.ta("click"); else {
                    var a = Xc(b);
                    if (a) {
                        var c = 0, f = "click".toString(), h;
                        for (h in a.o)if (!f || h == f)for (var l = a.o[h].concat(), t = 0; t < l.length; ++t)cd(l[t]) && ++c
                    }
                }
            })
        }
